/** v2.8.18-rc.2 | MIT Licensed */ !(function (d) {
  ...
  var t,
    ...
    g = function (t, e) {
      (e = e || "log"),
        d.console && console[e] && console[e]("layuiplay error hint: " + t);
    },
    ...
    s =
      ...
      (n.prototype.use = function (o, t, e, n) {
        var r,
          ...
          s =
            ...
            d.jQuery &&
              ...
              (layuiplay.jquery = layuiplay.$ = jQuery)),
            o[0]),
          c = 0;
        function p(t, e) {
          var o =
        ...
        function y() {
          e.push(layuiplay[s]),
            1 < o.length
              ...
              : "function" == typeof t &&
                (layuiplay.jquery &&
                "function" == typeof layuiplay.jquery &&
                "define" !== n
                  ? layuiplay.jquery(function () {
                      t.apply(layuiplay, e);
                    })
                  : t.apply(layuiplay, e));
        }
        return (
          ...
          0 === o.length || (layuiplay["layuiplay.all"] && N[s])
            ? y()
            : ((i = (i =
                (N[s]
                  ? u + "modules/"
                ...
                (a.modules[s] || s) +
                ".js").replace(/^\{\/\}/, "")),
              !m.modules[s] && layuiplay[s] && (m.modules[s] = i),
              m.modules[s]
                ? (function f() {
                    return ++c > (1e3 * m.timeout) / 4
                      ? g(s + " is not a valid module", "error")
      ...
      (n.prototype.addcss = function (t, e, o) {
        return layuiplay.link(m.dir + "css/" + t, e, o);
      }),
      (m.callback = {}),
      ...
      (n.prototype.data = function (t, e, o) {
        if (
          ((t = t || "layuiplay"), (o = o || localStorage), d.JSON && d.JSON.parse)
        ) {
      ...
      function (t, e, o, n) {
        ...
        return o === s
          ...
          ? ((m.event[t] = m.event[t] || {}),
            ...
            this)
          : (layuiplay.each(m.event[t], function (t, e) {
              ("{*}" === u || ("" === t && layuiplay.each(e, l), u && t === u)) &&
                layuiplay.each(e, l);
            }),
            i);
      }),
...
layuiplay.define(function (a) {
  var i = layuiplay.cache;
  layuiplay.config({ dir: i.dir.replace(/lay\/dest\/$/, "") }),
    a("layuiplay.all", layuiplay.v);
});
!(function (s) {
  "use strict";
  var t,
  ...
  (Array.prototype.indexOf =
    ...
    function (n, i) {
      ...
      return (
        (i = i || 0),
        layuiplay.each(this, function (t, e) {
    ...
    (d.extend = function () {
      var t,
        ...
        n = arguments,
        i = function (t, e) {
          for (var n in ((t = t || ("array" === layuiplay.type(e) ? [] : {})), e))
    ...
    (d.layuiplay = layuiplay || {}),
    (d.getPath = layuiplay.cache.dir),
    (d.stope = layuiplay.stope),
    (d.each = function () {
      return layuiplay.each.apply(layuiplay, arguments), this;
    }),
    ...
    s.layuiplay &&
      layuiplay.define &&
      layuiplay.define(function (t) {
        t("lay", d);
      });
})(window, window.document);
layuiplay.define(function (e) {
  "use strict";
  var c = { open: "{{", close: "}}" },
    l = {
      escape: function (e) {
    ...
    o =
      ...
      (t.prototype.view = function () {
        var e,
          ...
          l = {
            prev: n.prev
              ? '<a class="layuiplay-laypage-prev' +
                (1 == n.curr ? " " + a : "") +
                '" data-page="' +
                (n.curr - 1) +
                '">' +
            ...
            page: (function () {
              ...
              1 < u &&
                ...
                0 !== r &&
                e.push(
                  '<a class="layuiplay-laypage-first" data-page="1"  title="&#x9996;&#x9875;">' +
                    (n.first || 1) +
                    "</a>"
                );
              ...
              for (
                i - t < r - 1 && (t = i - r + 1),
                  !1 !== n.first &&
                    2 < t &&
                    e.push('<span class="layuiplay-laypage-spr">&#x2026;</span>');
                t <= i;
                t++
              )
                t === n.curr
                  ? e.push(
                      '<span class="layuiplay-laypage-curr"><em class="layuiplay-laypage-em" ' +
                        (/^#/.test(n.theme)
              ...
              return (
                n.pages > r &&
                  ...
                  0 !== r) &&
                  e.push(
                    '<a class="layuiplay-laypage-last" title="&#x5C3E;&#x9875;"  data-page="' +
                      n.pages +
                      '">' +
                      (n.last || n.pages) +
                      "</a>"
            ...
            next: n.next
              ? '<a class="layuiplay-laypage-next' +
                (n.curr == n.pages ? " " + a : "") +
                '" data-page="' +
                (n.curr + 1) +
                '">' +
              ...
              : "",
            count:
              '<span class="layuiplay-laypage-count">\u5171 ' +
              n.count +
              " \u6761</span>",
            limit:
              ((i = ['<span class="layuiplay-laypage-limits"><select lay-ignore>']),
              layuiplay.each(n.limits, function (e, a) {
                var t;
                i.push(
                  '<option value="' +
                    a +
              ...
              i.join("") + "</select></span>"),
            refresh: [
              '<a data-page="' + n.curr + '" class="layuiplay-laypage-refresh">',
              '<i class="layuiplay-icon layuiplay-icon-refresh"></i>',
              "</a>",
            ].join(""),
            skip: [
              '<span class="layuiplay-laypage-skip">' +
                (e =
              ...
              '<input type="text" min="1" value="' +
                n.curr +
                '" class="layuiplay-input">',
              e[1] +
                '<button type="button" class="layuiplay-laypage-btn">' +
                e[2] +
                "</button>",
              "</span>",
            ].join(""),
        ...
        return [
          '<div class="layuiplay-box layuiplay-laypage layuiplay-laypage-' +
            (n.theme ? (/^#/.test(n.theme) ? "molv" : n.theme) : "default") +
            '" id="layuiplay-laypage-' +
            n.index +
            '">',
          ((t = []),
          layuiplay.each(n.layout, function (e, a) {
            l[a] && t.push(l[a]);
          }),
          t.join("")),
          "</div>",
      ...
      }),
      {
        ...
        index: layuiplay.laypage ? layuiplay.laypage.index + 1e4 : 0,
        on: function (a, e, t) {
          return (
            a.attachEvent
...
!(function (i, v) {
  "use strict";
  var n = i.layuiplay && layuiplay.define,
    l = {
      getPath: i.lay && lay.getPath ? lay.getPath : "",
      link: function (e, t, a) {
        D.path && i.lay && lay.layuiplay && lay.layuiplay.link(D.path + e, t, a);
      },
    },
    e = i.layuiplay_GLOBAL || {},
    d = "layuiplay-laydate-id",
    D = {
      v: "5.5.0",
      config: { weekStart: 0 },
      ...
      ready: function (e) {
        ...
        return (
          n
            ? layuiplay["layuiplay.all"]
              ? "function" == typeof e && e()
              : layuiplay.addcss(a, e, t)
            : l.link(a, e, t),
          this
        );
      },
    ...
    k = "laydate-disabled",
    h = [100, 2e5],
    T = "layuiplay-laydate-static",
    w = "layuiplay-laydate-list",
    o = "laydate-selected",
    r = "layuiplay-laydate-hint",
    y = "laydate-day-prev",
    m = "laydate-day-next",
    C = ".laydate-btns-confirm",
    M = "laydate-time-text",
    L = "laydate-btns-time",
    E = "layuiplay-laydate-preview",
    S = "layuiplay-laydate-shade",
    I = function (e) {
      var t,
        a = this,
        n =
  ...
  (s.formatArr = function (e) {
    ...
    (I.prototype.init = function () {
      ...
      (o.elem = lay(o.elem)),
        ...
        o.elem[0] &&
          ("array" !== layuiplay.type(o.theme) && (o.theme = [o.theme]),
          o.fullPanel &&
          ...
          (r.elemID = "layuiplay-laydate" + o.elem.attr("lay-key")),
          (o.show || e) && r.render(),
          e || r.events(),
          o.value) &&
          o.isInitValue &&
          ("date" === layuiplay.type(o.value)
    ...
    (I.prototype.render = function () {
      var a,
        ...
        y = (r.elem = lay.elem("div", {
          ...
          class: [
            "layuiplay-laydate",
            o.range ? " layuiplay-laydate-range" : "",
            r.rangeLinked ? " layuiplay-laydate-linkage" : "",
            s ? " " + T : "",
        ...
        u = (r.elemCont = []),
        h = (r.table = []),
        e = (r.footer = lay.elem("div", { class: "layuiplay-laydate-footer" })),
        t = (r.shortcut = lay.elem("ul", { class: "layuiplay-laydate-shortcut" })),
        f =
          (o.zIndex && (y.style.zIndex = o.zIndex),
          lay.each(new Array(2), function (e) {
            if (!o.range && 0 < e) return !0;
            var a = lay.elem("div", { class: "layuiplay-laydate-header" }),
              t = [
                (((t = lay.elem("i", {
                  class: "layuiplay-icon laydate-icon laydate-prev-y",
                })).innerHTML = "&#xe65a;"),
                t),
                (((t = lay.elem("i", {
                  class: "layuiplay-icon laydate-icon laydate-prev-m",
                })).innerHTML = "&#xe603;"),
                t),
                ...
                t),
                (((n = lay.elem("i", {
                  class: "layuiplay-icon laydate-icon laydate-next-m",
                })).innerHTML = "&#xe602;"),
                n),
                (((l = lay.elem("i", {
                  class: "layuiplay-icon laydate-icon laydate-next-y",
                })).innerHTML = "&#xe65b;"),
                l),
              ],
              n = lay.elem("div", { class: "layuiplay-laydate-content" }),
              i = lay.elem("table"),
              l = lay.elem("thead"),
              r = lay.elem("tr");
            lay.each(t, function (e, t) {
              ...
              n.appendChild(i),
              (m[e] = lay.elem("div", {
                class: "layuiplay-laydate-main laydate-main-list-" + e,
              })),
              m[e].appendChild(a),
              m[e].appendChild(n),
              c.push(t),
            ...
            lay(t)
              ...
              .on("click", function (e) {
                var t = o.shortcuts[this.dataset.index] || {},
                  ...
                  n = (layuiplay.isArray(t) || (t = [t]), o.type),
                  t =
                    (lay.each(t, function (e, t) {
                      var a = [o.dateTime, r.endDate][e];
                      "time" === n && "date" !== layuiplay.type(t)
                        ? r.EXP_IF.test(t) &&
                        ...
                        : lay.extend(
                            a,
                            r.systemDate(
                              "date" === layuiplay.type(t) ? t : new Date(t)
                            )
                          ),
                        ("time" !== n && "datetime" !== n) ||
        ...
        t =
          (lay.each(o.theme, function (e, t) {
            g && /^#/.test(t)
              ? ((g = !(l = !0)),
                p.push(
                  [
                    "#{{id}} .layuiplay-laydate-header{background-color:{{theme}};}",
                    "#{{id}} li.layuiplay-this,#{{id}} td.layuiplay-this>div{background-color:{{theme}} !important;}",
                    -1 !== o.theme.indexOf("circle")
                      ? ""
                      : "#{{id}} .layuiplay-this{background-color:{{theme}} !important;}",
          ...
          o.shortcuts &&
            o.range &&
            p.push(
              "#{{id}}.layuiplay-laydate-range{width: 628px;}".replace(
                /{{id}}/g,
                r.elemID
              )
            ),
          ...
          o.shade
            ? '<div class="' +
              S +
              '" style="z-index:' +
              (parseInt(layuiplay.getStyle(y, "z-index")) - 1) +
              "; background-color: " +
              (o.shade[1] || "#000") +
              "; opacity: " +
              (o.shade[0] || o.shade) +
    ...
    (I.prototype.holidays = function (n, i) {
      var e = this.config,
        l = ["", "work"];
      return (
        "array" === layuiplay.type(e.holidays) &&
              ...
              .on("click", function () {
                ...
                lay(this).hasClass(k) ||
                  ...
                  d.autoCalendarModel.auto && !d.rangeLinked
                    ? d.choose(lay(h).find("td.layuiplay-this"), i)
            ...
            (i.rangeLinked
              ...
              : (r.year--,
                ...
                i.autoCalendarModel.auto
                  ? i.choose(lay(d).find("td.layuiplay-this"), n)
                  : i.done(null, "change")));
        },
        prevMonth: function () {
      ...
      n(v)
        ...
        n(i).on("resize", function () {
          if (D.thisId) {
            ...
            if (e)
              return !(!e.elem || !n(".layuiplay-laydate")[0]) && void e.position();
          }
        });
    }),
    (D.render = function (e) {
    ...
    n
      ? (D.ready(),
        layuiplay.define("lay", function (e) {
          (D.path = layuiplay.cache.dir), l.run(lay), e(a, D);
        }))
...
!(function (p) {
  ...
  var m,
    d,
    e,
    n = p.layuiplay && layuiplay.define,
    u = {
      getPath:
    ...
    h = {
      ...
      config: function (e, t) {
        return (
          ...
          e.extend &&
            (n
              ? layuiplay.addcss("modules/layer/" + e.extend)
              : u.link("css/" + e.extend)),
          this
        );
      },
      ...
      msg: function (e, t, i) {
        var n = "function" == typeof t,
          a = u.config.skin,
          a = (a ? a + " " + a + "-msg" : "") || "layuiplay-layer-msg",
          o = y.anim.length - 1;
        return (
          n && (i = t),
          h.open(
            m.extend(
              ...
              n && !u.config.skin
                ? { skin: a + " layuiplay-layer-hui", anim: o }
                : ((-1 !== (t = t || {}).icon &&
                    (void 0 !== t.icon || u.config.skin)) ||
                    (t.skin = a + " " + (t.skin || "layuiplay-layer-hui")),
                  t)
            )
          )
        );
    ...
    y =
      ...
      [
        "layuiplay-layer",
        ".layuiplay-layer-title",
        ".layuiplay-layer-main",
        ".layuiplay-layer-dialog",
        "layuiplay-layer-iframe",
        "layuiplay-layer-content",
        "layuiplay-layer-btn",
        "layuiplay-layer-close",
      ]),
    i =
      ((y.anim = {
        0: "layer-anim-00",
      ...
      (y.SHADE = "layuiplay-layer-shade"),
      (y.MOVE = "layuiplay-layer-move"),
      (t.pt.config = {
        type: 0,
        shade: 0.3,
        fixed: !0,
      ...
      (t.pt.vessel = function (e, t) {
        var i,
          ...
          s = a.title
            ? '<div class="layuiplay-layer-title" style="' +
              (s ? a.title[1] : "") +
              '">' +
              (s ? a.title[0] : a.title) +
              "</div>"
          ...
          t(
            [
              ...
              '<div class="' +
                ...
                "<div" +
                (a.id ? ' id="' + a.id + '"' : "") +
                ' class="layuiplay-layer-content' +
                (0 == a.type && -1 !== a.icon ? " layuiplay-layer-padding" : "") +
                (3 == a.type ? " layuiplay-layer-loading" + a.icon : "") +
                '">' +
                ((n = [
                  "layuiplay-icon-tips",
                  "layuiplay-icon-success",
                  "layuiplay-icon-error",
                  "layuiplay-icon-question",
                  "layuiplay-icon-lock",
                  "layuiplay-icon-face-cry",
                  "layuiplay-icon-face-smile",
                ]),
                (o = "layuiplay-anim layuiplay-anim-rotate layuiplay-anim-loop"),
                0 == a.type && -1 !== a.icon
                  ? '<i class="layuiplay-layer-face layuiplay-icon ' +
                    ((i =
                      16 == a.icon
                        ? "layuiplay-icon layuiplay-icon-loading " + o
                        : i) ||
                      n[a.icon] ||
                      n[0]) +
                    '"></i>'
                  : 3 == a.type
                  ? ((i = ["layuiplay-icon-loading", "layuiplay-icon-loading-1"]),
                    2 == a.icon
                      ? '<div class="layuiplay-layer-loading-2 ' + o + '"></div>'
                      : '<i class="layuiplay-layer-loading-icon layuiplay-icon ' +
                        (i[a.icon] || i[0]) +
                        " " +
                        o +
                        '"></i>')
                ...
                '</div><div class="layuiplay-layer-setwin">' +
                ((n = []),
                l &&
                  (n.push('<span class="layuiplay-layer-min"></span>'),
                  n.push('<span class="layuiplay-layer-max"></span>')),
                a.closeBtn &&
                  n.push(
                    '<span class="layuiplay-icon layuiplay-icon-close ' +
                      [
                        y[7],
                ...
                (a.btn
                  ...
                  : "") +
                (a.resize ? '<span class="layuiplay-layer-resize"></span>' : "") +
                "</div>",
            ],
            s,
          ...
          switch (
            ...
            case 2:
              ...
              s.content =
                ...
                y[4] +
                l +
                '" onload="this.className=\'\';" class="layuiplay-layer-load" frameborder="0" src="' +
                s.content[0] +
                '"></iframe>';
              break;
            case 3:
            ...
            case 4:
              r || (s.content = [s.content, "body"]),
                ...
                (s.content =
                  s.content[0] + '<i class="layuiplay-layer-TipsG"></i>'),
                delete s.title,
      ...
      (t.pt.tips = function () {
        var e = this.config,
          ...
          o = t.find(".layuiplay-layer-TipsG"),
          n = e.tips[0];
        e.tips[1] || o.remove(),
          (a.autoLeft = function () {
          ...
          (a.where = [
            function () {
              a.autoLeft(),
                ...
                o
                  .removeClass("layuiplay-layer-TipsB")
                  .addClass("layuiplay-layer-TipsT")
            ...
            function () {
              (a.tipLeft = a.left + a.width + 10),
                (a.tipTop = a.top),
                o
                  .removeClass("layuiplay-layer-TipsL")
                  .addClass("layuiplay-layer-TipsR")
            ...
            function () {
              a.autoLeft(),
                ...
                o
                  .removeClass("layuiplay-layer-TipsT")
                  .addClass("layuiplay-layer-TipsB")
                  .css("border-right-color", e.tips[1]);
            },
            function () {
              (a.tipLeft = a.left - i[0] - 10),
                (a.tipTop = a.top),
                o
                  .removeClass("layuiplay-layer-TipsR")
                  .addClass("layuiplay-layer-TipsL")
                  .css("border-bottom-color", e.tips[1]);
            },
          ]),
          a.where[n - 1](),
      ...
      (t.pt.move = function () {
        var n = this,
          ...
          t = o.find(a.move),
          i = o.find(".layuiplay-layer-resize");
        return (
      ...
      (t.pt.callback = function () {
        ...
        t.openLayer(),
          ...
          i.find(".layuiplay-layer-min").on("click", function () {
            !1 !== (n.min && n.min(i, t.index, t)) && h.min(t.index, n);
          }),
          i.find(".layuiplay-layer-max").on("click", function () {
            m(this).hasClass("layuiplay-layer-maxmin")
      ...
      (u.record = function (e) {
        ...
        e.find(".layuiplay-layer-max").addClass("layuiplay-layer-maxmin"),
          e.attr({ area: t });
      }),
      ...
      (h.style = function (e, t, i) {
        var e = m("#" + y[0] + e),
          n = e.find(".layuiplay-layer-content"),
          a = e.attr("type"),
      ...
      (h.restore = function (e) {
        ...
        t.removeData("maxminStatus"),
          ...
          t.find(".layuiplay-layer-max").removeClass("layuiplay-layer-maxmin"),
          t.find(".layuiplay-layer-min").show(),
        ...
        "max" !== e &&
          ...
          setTimeout(function () {
            ...
            h.style(
              ...
              i.find(".layuiplay-layer-min").hide();
          }, 100));
      }),
      ...
      (h.closeLast = function (e) {
        h.close(m(".layuiplay-layer-" + (e = e || "page") + ":last").attr("times"));
      }),
      h.cache || {}),
    g = function (e) {
  ...
  (h.prompt = function (i, n) {
    ...
    var a,
      o =
        2 == i.formType
          ? '<textarea class="layuiplay-layer-input"' + e + t + "></textarea>"
          : '<input type="' +
            (1 == i.formType ? "password" : "text") +
            '" class="layuiplay-layer-input"' +
            t +
            ">",
      s = i.success;
    return (
        ...
        m.extend(
          {
            ...
            btn: ["&#x786E;&#x5B9A;", "&#x53D6;&#x6D88;"],
            content: o,
            skin: "layuiplay-layer-prompt" + g("prompt"),
            maxWidth: d.width(),
            success: function (e) {
              (a = e.find(".layuiplay-layer-input")).val(i.value || "").focus(),
      ...
      return (
        ...
        h.open(
          m.extend(
            {
              type: 1,
              skin: "layuiplay-layer-tab" + g("tab"),
              resize: !1,
              title: (function () {
                var e = a.length,
                  t = 1,
              ...
              content:
                '<ul class="layuiplay-layer-tabmain">' +
                (function () {
                  var e = a.length,
                    t = 1,
                    i = "";
                  if (0 < e)
                    for (
                      i =
                        '<li class="layuiplay-layer-tabli ' +
                        o +
                        '">' +
                ...
                "</ul>",
              success: function (e) {
                var t = e.find(".layuiplay-layer-title").children(),
                  i = e.find(".layuiplay-layer-tabmain").children();
                t.on("mousedown", function (e) {
                  e.stopPropagation
                    ? e.stopPropagation()
                    : (e.cancelBubble = !0);
      ...
      if ((n = m.extend(!0, { toolbar: !0, footer: !0 }, n)).photos) {
        ...
        (o.imgprev = function (e) {
          ...
          (o.event = function (e, i, n) {
            o.main.find(".layuiplay-layer-photos-prev").on("click", function (e) {
              e.preventDefault(), o.imgprev(!0);
            }),
              o.main.find(".layuiplay-layer-photos-next").on("click", function (e) {
                ...
                m.extend(
                  {
                    ...
                    anim: 5,
                    isOutAnim: !1,
                    skin: "layuiplay-layer-photos" + g("photos"),
                    content:
                      ...
                      (s[l].pid || "") +
                      '">' +
                      ((t = ['<div class="layuiplay-layer-photos-pointer">']),
                      1 < s.length &&
                        t.push(
                          [
                            '<div class="layer-layer-photos-page">',
                            '<span class="layuiplay-icon layuiplay-icon-left layuiplay-layer-photos-prev"></span>',
                            '<span class="layuiplay-icon layuiplay-icon-right layuiplay-layer-photos-next"></span>',
                            "</div>",
                          ].join("")
                        ),
                      n.toolbar &&
                        t.push(
                          [
                            '<div class="layuiplay-layer-photos-toolbar layuiplay-layer-photos-header">',
                            '<span toolbar-event="rotate" data-option="90" title="\u65cb\u8f6c"><i class="layuiplay-icon layuiplay-icon-refresh"></i></span>',
                            '<span toolbar-event="scalex" title="\u53d8\u6362"><i class="layuiplay-icon layuiplay-icon-slider"></i></span>',
                            '<span toolbar-event="zoom" data-option="0.1" title="\u653e\u5927"><i class="layuiplay-icon layuiplay-icon-add-circle"></i></span>',
                            '<span toolbar-event="zoom" data-option="-0.1" title="\u7f29\u5c0f"><i class="layuiplay-icon layuiplay-icon-reduce-circle"></i></span>',
                            '<span toolbar-event="reset" title="\u8fd8\u539f"><i class="layuiplay-icon layuiplay-icon-refresh-1"></i></span>',
                            '<span toolbar-event="close" title="\u5173\u95ed"><i class="layuiplay-icon layuiplay-icon-close"></i></span>',
                            "</div>",
                          ].join("")
                        ),
                      n.footer &&
                        t.push(
                          [
                            '<div class="layuiplay-layer-photos-toolbar layuiplay-layer-photos-footer">',
                            "<h3>" + i + "</h3>",
                    ...
                    success: function (e, t, i) {
                      (o.main = e.find(".layer-layer-photos-main")),
                        (o.footer = e.find(".layuiplay-layer-photos-footer")),
    ...
    p.layuiplay && layuiplay.define
      ? (h.ready(),
        layuiplay.define("jquery", function (e) {
          (h.path = layuiplay.cache.dir), u.run(layuiplay.$), e("layer", (p.layer = h));
        }))
      : "function" == typeof define && define.amd
...
layuiplay.define("jquery", function (t) {
  "use strict";
  var s = layuiplay.$,
    p = layuiplay.hint(),
    o = {
      fixbar: function (i) {
        var o,
          ...
          l =
            (i["default"] &&
              (i.bar1 && i.bars.push({ type: "bar1", icon: "layuiplay-icon-chat" }),
              i.bar2 && i.bars.push({ type: "bar2", icon: "layuiplay-icon-help" }),
              i.bars.push({ type: "top", icon: "layuiplay-icon-top" })),
            s("<ul>").addClass(r));
        layuiplay.each(i.bars, function (t, e) {
          var n = s('<li class="layuiplay-icon">');
          n
            .addClass(e.icon)
            .attr({
              "lay-type": e.type,
            ...
            "object" === layuiplay.type(i.on) &&
              layuiplay.each(i.on, function (t, e) {
                n.on(t, function () {
                  var t = s(this).attr("lay-type");
                  "function" == typeof e && e.call(this, t);
                });
              }),
            "top" === e.type && (n.addClass("layuiplay-fixbar-top"), (o = n)),
            l.append(n);
        }),
          c.find("." + r).remove(),
...
layuiplay.define(["jquery", "laytpl", "lay", "util"], function (e) {
  "use strict";
  var n,
    i,
    t,
    ...
    p = layuiplay.util,
    a = layuiplay.hint(),
    o = layuiplay.device().mobile ? "touchstart" : "mousedown",
    r = "dropdown",
    y = "layuiplay_" + r + "_index",
    h = {
      config: { customName: { id: "id", title: "title", children: "child" } },
      index: layuiplay[r] ? layuiplay[r].index + 1e4 : 0,
      set: function (e) {
        var i = this;
        return (i.config = c.extend({}, i.config, e)), i;
      },
      on: function (e, i) {
        return layuiplay.onevent.call(this, r, e, i);
      },
    },
    f = function () {
      var i = this,
    ...
    g = "layuiplay-dropdown",
    l = "layuiplay-menu-item-up",
    d = "layuiplay-menu-item-down",
    v = "layuiplay-menu-body-title",
    u = "layuiplay-menu-item-group",
    w = "layuiplay-menu-item-parent",
    s = "layuiplay-menu-item-checked",
    V = "layuiplay-menu-item-checked2",
    x = "layuiplay-menu-body-panel",
    b = "layuiplay-menu-body-panel-left",
    C = "layuiplay-dropdown-shade",
    k = "." + u + ">." + v,
    E = function (e) {
      var i = this;
      (i.index = ++h.index),
  ...
  (E.prototype.config = {
    ...
    (E.prototype.render = function (e, i) {
      var l = this,
        ...
        t = c("body"),
        n = function () {
          var e = c('<ul class="layuiplay-menu layuiplay-dropdown-menu"></ul>');
          return (
            0 < d.data.length
              ? s(e, d.data)
              : e.html('<li class="layuiplay-menu-item-none">No data</li>'),
            e
          );
        },
        s = function (r, e) {
          return (
            layuiplay.each(e, function (e, i) {
              var t,
              ...
              ("-" === o || i[u.title] || i[u.id] || n) &&
                ((l = c(
                  [
                    "<li" +
                      ((t = {
                        group:
                          "layuiplay-menu-item-group" +
                          (d.isAllowSpread
                            ? a
                              ? " layuiplay-menu-item-down"
                              : " layuiplay-menu-item-up"
                            : ""),
                        parent: w,
                        "-": "layuiplay-menu-item-divider",
                      }),
                      n || o
                        ? ' class="' + t[o] + '"'
                        : i.disabled
                        ? ' class="layuiplay-disabled"'
                        : "") +
                      ">",
                    ((t =
                      "href" in i
                    ...
                    n
                      ? '<div class="' +
                        ...
                        t +
                        ("parent" === o
                          ? '<i class="layuiplay-icon layuiplay-icon-right"></i>'
                          : "group" === o && d.isAllowSpread
                          ? '<i class="layuiplay-icon layuiplay-icon-' +
                            (a ? "up" : "down") +
                            '"></i>'
                          : "") +
                        "</div>"
                ...
                n &&
                  ((a = c(
                    '<div class="layuiplay-panel layuiplay-menu-body-panel"></div>'
                  )),
                  (t = c("<ul></ul>")),
                  "parent" === o
        ...
        a = [
          '<div class="layuiplay-dropdown layuiplay-border-box layuiplay-panel layuiplay-anim layuiplay-anim-downbit" lay-id="' +
            d.id +
            '">',
          "</div>",
        ].join("");
      (!(e =
        ...
        l.elemView.find(".layuiplay-menu").on(o, function (e) {
          layuiplay.stope(e);
        }),
        l.elemView.find(".layuiplay-menu li").on("click", function (e) {
          var i = c(this),
            t = i.data("item") || {},
    ...
    (f.spread = function (e, i) {
      ...
      n(e, t),
        t &&
          i &&
          layuiplay.each(e.siblings("." + d), function (e, i) {
            n(c(i), !1);
          });
    }),
    (n = c(window)),
    ...
    (t = ".layuiplay-menu:not(.layuiplay-dropdown-menu) li"),
    i.on("click", t, function (e) {
      var i = c(this),
        t = i.parents(".layuiplay-menu").eq(0),
        n = i.hasClass(u) || i.hasClass(w),
        a = t.attr("lay-filter") || t.attr("id"),
        l = lay.options(this);
      i.hasClass("layuiplay-menu-item-divider") ||
        n ||
        ...
        layuiplay.event.call(this, r, "click(" + a + ")", l));
    }),
    i.on("click", t + k, function (e) {
      var i = c(this),
        ...
        i =
          "string" ==
          typeof i.parents(".layuiplay-menu").eq(0).attr("lay-accordion");
    ...
    (h.reloadData = function () {
      ...
      return (
        layuiplay.each(t[1], function (e, i) {
...
layuiplay.define(["jquery", "lay"], function (e) {
  "use strict";
  var g = layuiplay.$,
    c = layuiplay.lay,
    m = {
      config: {},
      index: layuiplay.slider ? layuiplay.slider.index + 1e4 : 0,
      set: function (e) {
        var i = this;
        return (i.config = g.extend({}, i.config, e)), i;
      },
      on: function (e, i) {
        return layuiplay.onevent.call(this, t, e, i);
      },
    },
    t = "slider",
    v = "layuiplay-disabled",
    x = "layuiplay-slider-bar",
    b = "layuiplay-slider-wrap",
    T = "layuiplay-slider-wrap-btn",
    w = "layuiplay-slider-tips",
    M = "layuiplay-slider-input-txt",
    L = "layuiplay-slider-hover",
    i = function (e) {
      var i = this;
      (i.index = ++m.index),
  ...
  (i.prototype.config = {
    ...
    (i.prototype.render = function () {
      ...
      var l,
        ...
        i =
          '<div class="layuiplay-slider ' +
          ("vertical" === n.type ? "layuiplay-slider-vertical" : "") +
          '">' +
          (n.tips ? '<div class="' + w + '"></div>' : "") +
          '<div class="layuiplay-slider-bar" style="background:' +
          e +
          "; " +
          ...
          ":" +
          (i || 0) +
          ';"></div><div class="layuiplay-slider-wrap" style="' +
          ("vertical" === n.type ? "bottom" : "left") +
          ":" +
          (i || t) +
          ';"><div class="layuiplay-slider-wrap-btn" style="border: 2px solid ' +
          e +
          ';"></div></div>' +
          (n.range
            ? '<div class="layuiplay-slider-wrap" style="' +
              ("vertical" === n.type ? "bottom" : "left") +
              ":" +
              s +
              ';"><div class="layuiplay-slider-wrap-btn" style="border: 2px solid ' +
      ...
      if (
        ...
        for (var o = (n.max - n.min) / n.step, r = "", d = 1; d < 1 + o; d++) {
          ...
          u < 100 &&
            (r +=
              '<div class="layuiplay-slider-step" style="' +
              ("vertical" === n.type ? "bottom" : "left") +
              ":" +
              u +
              '%"></div>');
      ...
      n.input &&
        !n.range &&
        ((e = g(
          '<div class="layuiplay-slider-input"><div class="layuiplay-slider-input-txt"><input type="text" class="layuiplay-input"></div><div class="layuiplay-slider-input-btn"><i class="layuiplay-icon layuiplay-icon-up"></i><i class="layuiplay-icon layuiplay-icon-down"></i></div></div>'
        )),
    ...
    (i.prototype.slide = function (e, i, t) {
      var o = this,
        ...
        c = d.find("." + b),
        m = d.next(".layuiplay-slider-input"),
        v = m
          .children("." + M)
          .children("input")
          .val(),
        ...
        y = g(
          [
            '<div class="layuiplay-auxiliar-moving" id="LAY-slider-moving"></div',
          ].join("")
        );
      ...
      d.find("." + T).each(function (l) {
        ...
        m
          .children(".layuiplay-slider-input-btn")
          .children("i")
          .each(function (i) {
...
layuiplay.define(["jquery", "lay"], function (e) {
  ...
  var m = layuiplay.$,
    t = layuiplay.lay,
    o = layuiplay.hint(),
    i = layuiplay.device().mobile ? "click" : "mousedown",
    n = {
      config: {},
      index: layuiplay.colorpicker ? layuiplay.colorpicker.index + 1e4 : 0,
      set: function (e) {
        var i = this;
        return (i.config = m.extend({}, i.config, e)), i;
      },
      on: function (e, i) {
        return layuiplay.onevent.call(this, "colorpicker", e, i);
      },
    },
    l = function () {
      var e = this.config,
    ...
    r = "colorpicker",
    c = "layuiplay-colorpicker",
    a = ".layuiplay-colorpicker-main",
    x = "layuiplay-icon-down",
    P = "layuiplay-icon-close",
    C = "layuiplay-colorpicker-trigger-span",
    w = "layuiplay-colorpicker-trigger-i",
    B = "layuiplay-colorpicker-side-slider",
    I = "layuiplay-colorpicker-basis",
    D = "layuiplay-colorpicker-alpha-bgcolor",
    T = "layuiplay-colorpicker-alpha-slider",
    E = "layuiplay-colorpicker-basis-cursor",
    M = "layuiplay-colorpicker-main-input",
    Y = function (e) {
      var i = { h: 0, s: 0, b: 0 },
  ...
  (d.prototype.config = {
    ...
    (d.prototype.render = function () {
      ...
      var o = m(
          [
            '<div class="layuiplay-unselect layuiplay-colorpicker">',
            "<span " +
              ("rgb" == i.format && i.alpha
                ? 'class="layuiplay-colorpicker-trigger-bgcolor"'
                : "") +
              ">",
            '<span class="layuiplay-colorpicker-trigger-span" ',
            'lay-type="' +
            ...
            'style="' +
              ...
              i.color
                ...
                : o) +
              '">',
            '<i class="layuiplay-icon layuiplay-colorpicker-trigger-i ' +
              (i.color ? x : P) +
              '"></i>',
            "</span>",
            "</span>",
        ...
        r = (i.elem = m(i.elem));
      i.size && o.addClass("layuiplay-colorpicker-" + i.size),
        r.addClass("layuiplay-inline").html((e.elemColorBox = o)),
    ...
    (d.prototype.renderPicker = function () {
      var o,
        ...
        t = (e.elemPicker = m(
          [
            '<div id="layuiplay-colorpicker' +
              e.index +
              '" data-index="' +
              e.index +
              '" class="layuiplay-anim layuiplay-anim-downbit layuiplay-colorpicker-main">',
            '<div class="layuiplay-colorpicker-main-wrapper">',
            '<div class="layuiplay-colorpicker-basis">',
            '<div class="layuiplay-colorpicker-basis-white"></div>',
            '<div class="layuiplay-colorpicker-basis-black"></div>',
            '<div class="layuiplay-colorpicker-basis-cursor"></div>',
            "</div>",
            '<div class="layuiplay-colorpicker-side">',
            '<div class="layuiplay-colorpicker-side-slider"></div>',
            "</div>",
            "</div>",
            '<div class="layuiplay-colorpicker-main-alpha ' +
              (i.alpha ? "layuiplay-show" : "") +
              '">',
            '<div class="layuiplay-colorpicker-alpha-bgcolor">',
            '<div class="layuiplay-colorpicker-alpha-slider"></div>',
            "</div>",
            "</div>",
            i.predefine
              ? ((o = ['<div class="layuiplay-colorpicker-main-pre">']),
                layuiplay.each(i.colors, function (e, i) {
                  o.push(
                    [
                      '<div class="layuiplay-colorpicker-pre' +
                        (3 < (i.match(/[0-9]{1,3}/g) || []).length
                          ? " layuiplay-colorpicker-pre-isalpha"
                          : "") +
                        '">',
                ...
                o.join(""))
              : "",
            '<div class="layuiplay-colorpicker-main-input">',
            '<div class="layuiplay-inline">',
            '<input type="text" class="layuiplay-input">',
            "</div>",
            '<div class="layuiplay-btn-container">',
            '<button class="layuiplay-btn layuiplay-btn-primary layuiplay-btn-sm" colorpicker-events="clear">\u6e05\u7a7a</button>',
            '<button class="layuiplay-btn layuiplay-btn-sm" colorpicker-events="confirm">\u786e\u5b9a</button>',
            "</div",
            "</div>",
            "</div>",
          ].join("")
    ...
    (d.prototype.removePicker = function (e) {
      var i = this.config,
        e = m("#layuiplay-colorpicker" + (e || this.index));
      return (
        e[0] &&
    ...
    (d.prototype.side = function () {
      var n = this,
        ...
        a = c.attr("lay-type"),
        s = n.elemPicker.find(".layuiplay-colorpicker-side"),
        ...
        i = n.elemPicker.find(".layuiplay-colorpicker-pre").children("div"),
        y = function (e, i, o, r) {
          n.select(e, i, o);
          var t = j({ h: e, s: i, b: o }),
            e = F({ h: e, s: i, b: o }),
        ...
        o = m(
          [
            '<div class="layuiplay-auxiliar-moving" id="LAY-colorpicker-moving"></div>',
          ].join("")
        ),
        k = function (e) {
      ...
      e.on("mousedown", function (e) {
        ...
        i.each(function () {
          m(this).on("click", function () {
            m(this)
              .parent(".layuiplay-colorpicker-pre")
              .addClass("selected")
              .siblings()
...
layuiplay.define("jquery", function (t) {
  "use strict";
  var u = layuiplay.$,
    d = (layuiplay.hint(), layuiplay.device()),
    c = "element",
    r = "layuiplay-this",
    h = "layuiplay-show",
    o = ".layuiplay-tab-title",
    i = function () {
      this.config = {};
    },
    y =
      ...
      (i.prototype.on = function (t, i) {
        return layuiplay.onevent.call(this, c, t, i);
      }),
      (i.prototype.tabAdd = function (t, i) {
        var a,
          e = u(".layuiplay-tab[lay-filter=" + t + "]"),
          l = e.children(o),
          n = l.children(".layuiplay-tab-bar"),
          e = e.children(".layuiplay-tab-content"),
          s =
            "<li" +
            ((a = []),
            layuiplay.each(i, function (t, i) {
        ...
        return (
          ...
          e.append(
            '<div class="layuiplay-tab-item">' + (i.content || "") + "</div>"
          ),
      ...
      (i.prototype.tabDelete = function (t, i) {
        t = u(".layuiplay-tab[lay-filter=" + t + "]")
          .children(o)
          .find('>li[lay-id="' + i + '"]');
      ...
      ".layuiplay-nav"),
    f = "layuiplay-nav-item",
    p = "layuiplay-nav-bar",
    b = "layuiplay-nav-tree",
    v = "layuiplay-nav-child",
    m = "layuiplay-nav-more",
    g = "layuiplay-anim layuiplay-anim-upbit",
    C = {
      tabClick: function (t) {
        var i = (t = t || {}).options || {},
          a = t.liElem || u(this),
          e = i.headerElem ? a.parent() : a.parents(".layuiplay-tab").eq(0),
          i = i.bodyElem
            ? u(i.bodyElem)
            : e.children(".layuiplay-tab-content").children(".layuiplay-tab-item"),
          l = a.find("a"),
          l =
        ...
        l ||
          ...
          layuiplay.event.call(this, c, "tab(" + s + ")", { elem: e, index: t });
      },
      tabDelete: function (t, i) {
        var i = i || u(this).parent(),
          a = i.parent().children("li").index(i),
          e = i.closest(".layuiplay-tab"),
          l = e.children(".layuiplay-tab-content").children(".layuiplay-tab-item"),
          n = e.attr("lay-filter");
        i.hasClass(r) &&
          ...
          layuiplay.event.call(this, c, "tabDelete(" + n + ")", {
            elem: e,
            index: a,
          });
      },
      tabAuto: function (l) {
        var n = "layuiplay-tab-more",
          s = "layuiplay-tab-bar",
          o = "layuiplay-tab-close",
          c = this;
        u(".layuiplay-tab").each(function () {
          var t,
            i = u(this),
            a = i.children(".layuiplay-tab-title"),
            e =
              (i.children(".layuiplay-tab-content").children(".layuiplay-tab-item"),
              'lay-stope="tabmore"'),
            e = u(
              '<span class="layuiplay-unselect layuiplay-tab-bar" ' +
                e +
                "><i " +
                e +
                ' class="layuiplay-icon">&#xe61a;</i></span>'
            );
          c === window && d.ie,
            i.attr("lay-allowclose") &&
              a.find("li").each(function () {
                ...
                i.find("." + o)[0] ||
                  ((t = u(
                    '<i class="layuiplay-icon layuiplay-icon-close layuiplay-unselect ' +
                      o +
                      '"></i>'
      ...
      hideTabMore: function (t) {
        var i = u(".layuiplay-tab-title");
        (!0 !== t && "tabmore" === u(t.target).attr("lay-stope")) ||
          (i.removeClass("layuiplay-tab-more"),
          i.find(".layuiplay-tab-bar").attr("title", ""));
      },
      clickThis: function () {
        var t = u(this),
          i = t.closest(y),
        ...
        layuiplay.event.call(this, c, "nav(" + a + ")", t);
      },
      collapse: function () {
        var t = u(this),
          i = t.find(".layuiplay-colla-icon"),
          a = t.siblings(".layuiplay-colla-content"),
          e = t.parents(".layuiplay-collapse").eq(0),
          l = e.attr("lay-filter"),
          n = "none" === a.css("display");
        "string" == typeof e.attr("lay-accordion") &&
          ((e = e.children(".layuiplay-colla-item").children("." + h))
            .siblings(".layuiplay-colla-title")
            .children(".layuiplay-colla-icon")
            .html("&#xe602;"),
          e.removeClass(h)),
          a[n ? "addClass" : "removeClass"](h),
          i.html(n ? "&#xe61a;" : "&#xe602;"),
          layuiplay.event.call(this, c, "collapse(" + l + ")", {
            title: t,
            content: a,
            show: n,
          });
        ...
        function (t, i) {
          var a = i ? '[lay-filter="' + i + '"]' : "",
            i = {
                  ...
                  i.find("." + p)[0] ||
                      ...
                      .on("mouseenter", function () {
                        !function (t, i, a) {
                          ...
                          i.hasClass(b)
                            ...
                            : (n.addClass(g),
                              n.hasClass("layuiplay-nav-child-c") &&
                                n.css({
                    ...
                    e.find("a").each(function () {
                      ...
                      t.siblings("." + v)[0] &&
                        !t.children("." + m)[0] &&
                        t.append(
                          '<i class="layuiplay-icon layuiplay-icon-down ' + m + '"></i>'
                        ),
              ...
              breadcrumb: function () {
                u(".layuiplay-breadcrumb" + a).each(function () {
                  var t = u(this),
                    i = "lay-separator",
                    a = t.attr(i) || "/",
                    e = t.find("a");
              ...
              progress: function () {
                var e = "layuiplay-progress";
                u("." + e + a).each(function () {
                  var t = u(this),
                    i = t.find(".layuiplay-progress-bar"),
              ...
              collapse: function () {
                u(".layuiplay-collapse" + a).each(function () {
                  u(this)
                    .find(".layuiplay-colla-item")
                    .each(function () {
                      var t = u(this),
                        i = t.find(".layuiplay-colla-title"),
                        t =
                          "none" ===
                          t.find(".layuiplay-colla-content").css("display");
                      i.find(".layuiplay-colla-icon").remove(),
                        i.append(
                          '<i class="layuiplay-icon layuiplay-colla-icon">' +
                            (t ? "&#xe602;" : "&#xe61a;") +
                            "</i>"
                        ),
  ...
  u(function () {
    ...
    e.on("click", ".layuiplay-tab-title li", C.tabClick),
    u(window).on("resize", C.tabAuto),
    t(c, a);
});
layuiplay.define(["lay", "layer"], function (e) {
  "use strict";
  var x = layuiplay.$,
    a = layuiplay.lay,
    i = layuiplay.layer,
    b = layuiplay.device(),
    t = "upload",
    r = "layuiplay_" + t + "_index",
    o = {
      config: {},
      index: layuiplay[t] ? layuiplay[t].index + 1e4 : 0,
      set: function (e) {
        var i = this;
    ...
    u = "layuiplay-upload-file",
    f = "layuiplay-upload-form",
    F = "layuiplay-upload-iframe",
    w = "layuiplay-upload-choose",
    L = "UPLOADING",
    j = function (e) {
      var i = this;
      (i.index = ++o.index),
  ...
  (j.prototype.config = {
    ...
    (j.prototype.file = function () {
      ...
      (n.hasClass(u) || n.hasClass(f)) && n.remove(),
        b.ie &&
          b.ie < 10 &&
          i.elem.wrap('<div class="layuiplay-upload-wrap"></div>'),
        e.isFile()
      ...
      x("#" + F)[0] || x("body").append(i),
        e.elem.next().hasClass(f) ||
          ...
          e.elem.next("." + f).append(
            ((t = []),
            layuiplay.each(e.data, function (e, i) {
    ...
    (j.prototype.preview = function (n) {
      window.FileReader &&
        layuiplay.each(this.chooseFiles, function (e, i) {
    ...
    (j.prototype.upload = function (e, i) {
      var t,
          ...
          var a = 0,
            ...
            t = function (t) {
              var n = new FormData(),
                i = function (e) {
                  t.unified
                    ? layuiplay.each(l, function (e, i) {
                        delete i[L];
                      })
                    : delete e[L];
                };
              if (
                (layuiplay.each(f.data, function (e, i) {
        ...
        g =
          ((n = []),
          layuiplay.each(e || u.chooseFiles, function (e, i) {
            n.push(i.name);
          }),
          n),
        v = {
          ...
          pushFile: function () {
            return (
              (u.files = u.files || {}),
              layuiplay.each(u.chooseFiles, function (e, i) {
                u.files[e] = i;
              }),
              u.files
            );
      ...
      var n = this,
        ...
        l = function (e, i) {
          ...
          t.next().hasClass(w) && t.next().remove(),
            ...
            n.isFile() ||
              a.choose ||
              t.after('<span class="layuiplay-inline ' + w + '">' + e + "</span>");
        };
...
layuiplay.define(["lay", "layer", "util"], function (e) {
  "use strict";
  var C = layuiplay.$,
    h = layuiplay.layer,
    d = layuiplay.util,
    l = layuiplay.hint(),
    w = (layuiplay.device(), "form"),
    o = ".layuiplay-form",
    N = "layuiplay-this",
    T = "layuiplay-hide",
    $ = "layuiplay-disabled",
    ...
    i =
      ...
      (t.prototype.on = function (e, t) {
        return layuiplay.onevent.call(this, w, e, t);
      }),
      (t.prototype.val = function (e, i) {
        return (
          this.getFormElem(e).each(function (e, t) {
            var a = C(this);
            layuiplay.each(i, function (e, t) {
              var i,
                e = a.find('[name="' + e + '"]');
              e[0] &&
                ("checkbox" === (i = e[0].type)
      ...
      (t.prototype.render = function (e, t) {
        var i = this.config,
          ...
          n = {
            input: function (e) {
                  ...
                  function (e, t) {
                    ...
                    isNaN(a) ||
                      ...
                      o ||
                        ...
                        e.val(a)),
                      (n = {
                        increment: e.next().find(".layuiplay-icon-up"),
                        decrement: e.next().find(".layuiplay-icon-down"),
              ...
              a.find("input[lay-affix],textarea[lay-affix]").each(function () {
                var r = C(this),
                  s = r.attr("lay-affix"),
                  o = "layuiplay-input-wrap",
                  c = "layuiplay-input-suffix",
                  u = "layuiplay-input-affix",
                  ...
                  n = function (i) {
                    ...
                    var a,
                      t = C('<div class="' + u + '">'),
                      e = layuiplay.isArray(i.value) ? i.value : [i.value],
                      e = C(
                        ((a = []),
                        layuiplay.each(e, function (e, t) {
                          a.push(
                      ...
                      n =
                        (t.append(e),
                        i.split && t.addClass("layuiplay-input-split"),
                    ...
                    l[0]
                      ? ((n = l.find("." + u))[0] && n.remove(),
                        ...
                        r.css("padding-right", function () {
                          return (
                            (r.closest(".layuiplay-input-group")[0]
                              ? 0
                      ...
                      e.on("click", function () {
                        ...
                        C(this).hasClass($) ||
                          ...
                          layuiplay.event.call(this, w, "input-affix(" + e + ")", {
                            elem: r[0],
                            affix: s,
                            options: i,
                          }));
                  ...
                  f = {
                    ...
                    number: {
                      value: ["up", "down"],
                      split: !0,
                      className: "layuiplay-input-number",
            ...
            select: function (e) {
              var p,
                c = "\u8bf7\u9009\u62e9",
                m = "layuiplay-form-select",
                x = "layuiplay-select-title",
                g = "layuiplay-select-none",
                b = "",
                e = e || a.find("select"),
                k = function (e, t) {
                ...
                u = function (a, e, t) {
                  ...
                  e ||
                    ...
                    u.find(".layuiplay-edge").on("click", function () {
                      d.focus();
                    }),
                    d
                      .on("keyup", function (e) {
                    ...
                    h.on("click", function () {
                      ...
                      return (
                        e.hasClass($) ||
                          (e.hasClass("layuiplay-select-tips")
                            ? d.val("")
                            : (d.val(e.text()), e.addClass(N)),
                          e.siblings().removeClass(N),
                          c.val(t).removeClass("layuiplay-form-danger"),
                          layuiplay.event.call(this, w, "select(" + i + ")", {
                            elem: c[0],
                            value: t,
                            othis: a,
                          }),
              ...
              e.each(function (e, t) {
                ...
                var s,
                  ...
                  r = C(
                    [
                      '<div class="' + (o ? "" : "layuiplay-unselect ") + m,
                      (n ? " layuiplay-select-disabled" : "") + '">',
                      '<div class="' + x + '">',
                      '<input type="text" placeholder="' +
                        ...
                        (!n && o ? "" : " readonly") +
                        ' class="layuiplay-input' +
                        (o ? "" : " layuiplay-unselect") +
                        (n ? " " + $ : "") +
                        '">',
                      '<i class="layuiplay-edge"></i></div>',
                      '<dl class="layuiplay-anim layuiplay-anim-upbit' +
                        (i.find("optgroup")[0] ? " layuiplay-select-group" : "") +
                        '">',
                      ((t = i.find("*")),
                      (s = []),
                      layuiplay.each(t, function (e, t) {
                        ...
                        0 !== e || t.value || "optgroup" === i
                          ...
                          : s.push(
                              '<dd lay-value="" class="layuiplay-select-tips">' +
            ...
            checkbox: function (e) {
              var o = {
                  checkbox: [
                    "layuiplay-form-checkbox",
                    "layuiplay-form-checked",
                    "checkbox",
                  ],
                  switch: [
                    "layuiplay-form-switch",
                    "layuiplay-form-onswitch",
                    "switch",
                  ],
                  SUBTRA: "layuiplay-icon-indeterminate",
                },
              ...
              e.each(function (e, t) {
                ...
                l = C(
                  [
                    '<div class="layuiplay-unselect ' + r[0],
                    t.checked ? " " + r[1] : "",
                    l ? " layuiplay-checkbox-disabled " + $ : "",
                    '"',
                    a ? ' lay-skin="' + a + '"' : "",
                    ">",
                    (s = {
                  ...
                  function (a, n) {
                    ...
                    a.on("click", function () {
                      ...
                      l[0].disabled ||
                        ...
                        layuiplay.event.call(l[0], w, n[2] + "(" + t + ")", {
                          elem: l[0],
                          value: l[0].value,
                          othis: a,
                        }));
            ...
            radio: function (e) {
              var r = "layuiplay-form-radio",
                s = ["layuiplay-icon-radio", "layuiplay-icon-circle"],
              ...
              e.each(function (e, t) {
                ...
                n = C(
                  [
                    '<div class="layuiplay-unselect ' + r,
                    t.checked ? " " + r + "ed" : "",
                    (n ? " layuiplay-radio-disabled " + $ : "") + '">',
                    '<i class="layuiplay-anim layuiplay-icon ' +
                      s[t.checked ? 0 : 1] +
                      '"></i>',
                    "<div>" +
                      ((a = d.escape(t.title || "")),
                      ...
                      n[0].disabled ||
                        (layuiplay.each(e, function () {
                          ...
                          (this.checked = !1),
                            e.removeClass(r + "ed"),
                            e
                              .children(".layuiplay-icon")
                              .removeClass(l + " " + s[0])
                              .addClass(s[1]);
                        }),
                        (n[0].checked = !0),
                        a.addClass(r + "ed"),
                        a.children(".layuiplay-icon").addClass(l + " " + s[0]),
                        layuiplay.event.call(n[0], w, "radio(" + i + ")", {
                          elem: n[0],
                          value: n[0].value,
                          othis: a,
                        }));
          ...
          t = function () {
            layuiplay.each(n, function (e, t) {
              t();
            });
          };
        return (
          "object" === layuiplay.type(e)
            ? C(e).is(o)
              ? ((a = C(e)), t())
              : e.each(function (e, t) {
                  var i = C(t);
      ...
      (t.prototype.submit = function (e, t) {
        ...
        return (
          ...
          layuiplay.event.call(this, w, "submit(" + e + ")", l))
        );
      })),
    r = new t(),
    t = C(document),
...
layuiplay.define(["lay", "laytpl", "laypage", "form", "util"], function (n) {
  "use strict";
  var f = layuiplay.$,
    r = layuiplay.lay,
    m = layuiplay.laytpl,
    ...
    k = {
      ...
      cache: {},
      index: layuiplay.table ? layuiplay.table.index + 1e4 : 0,
      set: function (e) {
        var t = this;
        return (t.config = f.extend({}, t.config, e)), t;
      },
      on: function (e, t) {
        return layuiplay.onevent.call(this, N, e, t);
      },
    },
    w = function () {
      var a = this,
    ...
    y = "layuiplay-hide-v",
    h = "layuiplay-none",
    L = "layuiplay-table-view",
    o = ".layuiplay-table-header",
    A = ".layuiplay-table-body",
    D = ".layuiplay-table-pageview",
    _ = ".layuiplay-table-sort",
    E = "layuiplay-table-checked",
    W = "layuiplay-table-edit",
    j = "layuiplay-table-hover",
    z = "laytable-cell-group",
    M = "layuiplay-table-col-special",
    H = "layuiplay-table-tool-panel",
    S = "layuiplay-table-expanded",
    F = "LAY_TABLE_MOVE_DICT",
    e = function (e) {
      return [
        '<table cellspacing="0" cellpadding="0" border="0" class="layuiplay-table" ',
        '{{# if(d.data.skin){ }}lay-skin="{{=d.data.skin}}"{{# } }} {{# if(d.data.size){ }}lay-size="{{=d.data.size}}"{{# } }} {{# if(d.data.even){ }}lay-even{{# } }}>',
        "<thead>",
        "{{# layuiplay.each(d.data.cols, function(i1, item1){ }}",
        "<tr>",
        "{{# layuiplay.each(item1, function(i2, item2){ }}",
        ...
        '<th data-field="{{= item2.field||i2 }}" data-key="{{=d.index}}-{{=i1}}-{{=i2}}" {{# if( item2.parentKey){ }}data-parentkey="{{= item2.parentKey }}"{{# } }} {{# if(item2.minWidth){ }}data-minwidth="{{=item2.minWidth}}"{{# } }} {{# if(item2.maxWidth){ }}data-maxwidth="{{=item2.maxWidth}}"{{# } }} {{# if(item2.style){ }}style="{{=item2.style}}"{{# } }} {{#var colspan = layuiplay.type(item2.colspan2) === \'number\' ? item2.colspan2 : item2.colspan; if(colspan){}} colspan="{{=colspan}}"{{#} if(item2.rowspan){}} rowspan="{{=item2.rowspan}}"{{#}}} {{# if(item2.unresize || item2.colGroup){ }}data-unresize="true"{{# } }} class="{{# if(item2.hide){ }}layuiplay-hide{{# } }}{{# if(isSort){ }} layuiplay-unselect{{# } }}{{# if(!item2.field){ }} layuiplay-table-col-special{{# } }}"{{# if(item2.title){ }} title="{{ layuiplay.$(\'<div>\' + item2.title + \'</div>\').text() }}"{{# } }}>',
        '<div class="layuiplay-table-cell laytable-cell-',
        "{{# if(item2.colGroup){ }}",
        "group",
        "{{# } else { }}",
        "{{=d.index}}-{{=i1}}-{{=i2}}",
        ...
        "{{# if(isSort){ }}",
        '<span class="layuiplay-table-sort layuiplay-inline"><i class="layuiplay-edge layuiplay-table-sort-asc" title="\u5347\u5e8f"></i><i class="layuiplay-edge layuiplay-table-sort-desc" title="\u964d\u5e8f"></i></span>',
        "{{# } }}",
        "{{# } }}",
        "</div>",
        "</th>",
    ...
    s = [
      ,
      "{{# if(d.data.toolbar){ }}",
      '<div class="layuiplay-table-tool">',
      '<div class="layuiplay-table-tool-temp"></div>',
      '<div class="layuiplay-table-tool-self"></div>',
      "</div>",
      "{{# } }}",
      '<div class="layuiplay-table-box">',
      "{{# if(d.data.loading){ }}",
      '<div class="layuiplay-table-init" style="background-color: #fff;">',
      '<i class="layuiplay-icon layuiplay-icon-loading layuiplay-anim layuiplay-anim-rotate layuiplay-anim-loop"></i>',
      "</div>",
      "{{# } }}",
      "{{# var left, right; }}",
      '<div class="layuiplay-table-header">',
      e(),
      "</div>",
      '<div class="layuiplay-table-body layuiplay-table-main">',
      a,
      "</div>",
      "{{# if(left){ }}",
      '<div class="layuiplay-table-fixed layuiplay-table-fixed-l">',
      '<div class="layuiplay-table-header">',
      e({ fixed: !0 }),
      "</div>",
      '<div class="layuiplay-table-body">',
      a,
      "</div>",
      "</div>",
      "{{# }; }}",
      "{{# if(right){ }}",
      '<div class="layuiplay-table-fixed layuiplay-table-fixed-r layuiplay-hide">',
      '<div class="layuiplay-table-header">',
      e({ fixed: "right" }),
      '<div class="layuiplay-table-mend"></div>',
      "</div>",
      '<div class="layuiplay-table-body">',
      a,
      "</div>",
      ...
      "</div>",
      "{{# if(d.data.totalRow){ }}",
      '<div class="layuiplay-table-total">',
      '<table cellspacing="0" cellpadding="0" border="0" class="layuiplay-table" ',
      '{{# if(d.data.skin){ }}lay-skin="{{=d.data.skin}}"{{# } }} {{# if(d.data.size){ }}lay-size="{{=d.data.size}}"{{# } }} {{# if(d.data.even){ }}lay-even{{# } }}>',
      '<tbody><tr><td><div class="layuiplay-table-cell" style="visibility: hidden;">Total</div></td></tr></tbody>',
      "</table>",
      "</div>",
      "{{# } }}",
      '<div class="layuiplay-table-column layuiplay-table-page layuiplay-hide">',
      '<div class="layuiplay-inline layuiplay-table-pageview" id="layuiplay-table-page{{=d.index}}"></div>',
      "</div>",
    ].join(""),
    d = f(window),
    I = f(document),
    ...
    c =
      ...
      (i.prototype.render = function (e) {
        ...
        n
          .addClass(
            ((l = [L, L + "-" + t.index, "layuiplay-form", "layuiplay-border-box"]),
          ...
          i[0] && i.remove(),
          e.after(n),
          (t.layTool = n.find(".layuiplay-table-tool")),
          (t.layBox = n.find(".layuiplay-table-box")),
          (t.layHeader = n.find(o)),
          (t.layMain = n.find(".layuiplay-table-main")),
          (t.layBody = n.find(A)),
          (t.layFixed = n.find(".layuiplay-table-fixed")),
          (t.layFixLeft = n.find(".layuiplay-table-fixed-l")),
          (t.layFixRight = n.find(".layuiplay-table-fixed-r")),
          (t.layTotal = n.find(".layuiplay-table-total")),
          (t.layPage = n.find(".layuiplay-table-page")),
          t.renderToolbar(),
          t.renderPagebar(),
          t.fullSize(),
          t.pullData(t.page),
      ...
      (i.prototype.setInit = function (e) {
          ...
          l
            ? ((l.key = [r.index, a, i].join("-")),
              ...
              (n = a + (parseInt(l.rowspan) || 1)) < r.cols.length
                ? ((l.colGroup = !0),
                  (o = 0),
                  layuiplay.each(r.cols[n], function (e, t) {
                    t.HAS_PARENT ||
                      (1 <= o && o == (l.colspan || 1)) ||
                      ((t.HAS_PARENT = !0),
        ...
        layuiplay.each(r.cols, function (a, i) {
          layuiplay.each(i, function (e, t) {
      ...
      (i.prototype.renderStyle = function () {
        var e,
          ...
          n = this.index,
          o = [];
        layuiplay.each(l.cols, function (a, e) {
          layuiplay.each(e, function (e, t) {
            (e = [n, a, e].join("-")),
          ...
          (e = l.lineStyle) &&
            ((a =
              ".layuiplay-table-view-" + n + " .layuiplay-table-body .layuiplay-table tr"),
            (t = e.split(";")),
            (i = "none"),
            layuiplay.each(t, function (e, t) {
            ...
            layuiplay.each(
              [
                "{" + e + "}",
                ".layuiplay-table-cell{height: auto; max-height: " +
                  i +
                  "; white-space: normal; text-overflow: clip;}",
                "> td:hover > .layuiplay-table-cell{overflow: auto;}",
              ].concat(
                x.ie
                  ? [
                      ".layuiplay-table-edit{height: " + i + ";}",
      ...
      (i.prototype.renderToolbar = function () {
        var e = this.config,
          t = [
            '<div class="layuiplay-inline" lay-event="add"><i class="layuiplay-icon layuiplay-icon-add-1"></i></div>',
            '<div class="layuiplay-inline" lay-event="update"><i class="layuiplay-icon layuiplay-icon-edit"></i></div>',
            '<div class="layuiplay-inline" lay-event="delete"><i class="layuiplay-icon layuiplay-icon-delete"></i></div>',
          ].join(""),
          a = this.layTool.find(".layuiplay-table-tool-temp"),
          i =
            ("default" === e.toolbar
              ? a.html(t)
                ...
                a.html(m(t).render(e)),
            {
              filter: {
                ...
                icon: "layuiplay-icon-cols",
              },
              exports: {
                title: "\u5bfc\u51fa",
                layEvent: "LAYTABLE_EXPORT",
                icon: "layuiplay-icon-export",
              },
              print: {
                title: "\u6253\u5370",
                layEvent: "LAYTABLE_PRINT",
                icon: "layuiplay-icon-print",
              },
            }),
          l = [];
        "object" == typeof e.defaultToolbar &&
          layuiplay.each(e.defaultToolbar, function (e, t) {
            t = "string" == typeof t ? i[t] : t;
            t &&
              l.push(
                '<div class="layuiplay-inline" title="' +
                  t.title +
                  '" lay-event="' +
                  t.layEvent +
                  '"><i class="layuiplay-icon ' +
          ...
          this.layTool.find(".layuiplay-table-tool-self").html(l.join(""));
      }),
      (i.prototype.renderPagebar = function () {
        var e,
          t = this.config,
          a = (this.layPagebar = f(
            '<div class="layuiplay-inline layuiplay-table-pagebar"></div>'
          ));
        t.pagebar &&
      ...
      (i.prototype.setColsPatch = function () {
        var a = this,
          e = a.config;
        layuiplay.each(e.cols, function (e, t) {
          layuiplay.each(t, function (e, t) {
      ...
      (i.prototype.setGroupWidth = function (i) {
        ...
        l.config.cols.length <= 1 ||
          ...
          layuiplay.each(e.get().reverse(), function () {
            var e = f(this),
              t = e.parent().data("key"),
              a = 0;
            l.layHeader
        ...
        var t,
          ...
          e =
            ...
            (u =
              ...
              1),
            function (o) {
              layuiplay.each(d.cols, function (e, n) {
                layuiplay.each(n, function (e, t) {
                  var a = 0,
      ...
      (i.prototype.reload = function (e, t, a) {
        ...
        (e = e || {}),
          delete i.haveInit,
          layuiplay.each(e, function (e, t) {
            "array" === layuiplay.type(t) && delete i.config[e];
          }),
          (i.config = f.extend(t, {}, i.config, e)),
          "reloadData" !== a &&
            (layuiplay.each(i.config.cols, function (e, t) {
              layuiplay.each(t, function (e, t) {
                delete t.colspan2;
              });
            }),
      ...
      (i.prototype.getTrHtml = function (a, l, n, e) {
        ...
        return (
          ...
          layuiplay.each(a, function (e, o) {
            ...
            ("array" === layuiplay.type(o) && 0 === o.length) ||
              ...
              o
                ...
                : (u(),
                  ...
                  void (
                    ...
                    ((i.page = f.extend(
                      {
                        elem: "layuiplay-table-page" + i.index,
                        count: n,
                        limit: i.limit,
                        limits: i.limits || [
                        ...
                        prev: '<i class="layuiplay-icon">&#xe603;</i>',
                        next: '<i class="layuiplay-icon">&#xe602;</i>',
                        jump: function (e, t) {
                          t ||
                            ((a.page = e.curr),
                            (i.limit = e.limit),
      ...
      (i.prototype.renderTotal = function (e, o) {
        ...
        c.totalRow &&
          (layuiplay.each(e, function (e, i) {
            ("array" === layuiplay.type(i) && 0 === i.length) ||
          ...
          (e = r.layTotal.find(".layuiplay-table-patch")),
          r.layTotal
            .find("tbody")
            .html(
              "<tr>" +
      ...
      (i.prototype.setRowActive = function (e, t, a) {
        ...
        if (((t = t || "layuiplay-table-click"), a)) return e.removeClass(t);
      ...
      (i.prototype.sort = function (l) {
        ...
        (t.sortKey = { field: d, sort: l.type }),
          i.autoSort &&
            ("asc" === l.type
              ? (e = layuiplay.sort(o, d, null, !0))
              : "desc" === l.type
              ? (e = layuiplay.sort(o, d, !0, !0))
              : ((e = layuiplay.sort(o, k.config.indexName, null, !0)),
                delete t.sortKey,
                delete i.initSort)),
        ...
        t.config.loading &&
          (e
            ? (t.layInit && t.layInit.remove(),
              delete t.layInit,
              t.layBox.find(".layuiplay-table-init").remove())
            : ((t.layInit = f(
                [
                  '<div class="layuiplay-table-init">',
                  '<i class="layuiplay-icon layuiplay-icon-loading layuiplay-anim layuiplay-anim-rotate layuiplay-anim-loop"></i>',
                  "</div>",
                ].join("")
              )),
      ...
      (i.prototype.fullSize = function () {
        ...
        i.fullHeightGap
          ...
          l &&
            ...
            t.maxHeight
              ? layuiplay.each({ elem: l, layMain: e }, function (e, t) {
      ...
      (i.prototype.scrollPatch = function () {
        var e = this,
          ...
          n = function (e) {
            var t;
            a && i
              ? (e = e.eq(0)).find(".layuiplay-table-patch")[0] ||
                ((t = f(
                  '<th class="layuiplay-table-patch"><div class="layuiplay-table-cell"></div></th>'
                ))
                  .find("div")
                  .css({ width: a }),
                e.find("tr").append(t))
              : e.find(".layuiplay-table-patch").remove();
          };
      ...
      (i.prototype.events = function () {
        var s = this,
                    ...
                    list:
                      ...
                      v.on("checkbox(LAY_TABLE_TOOL_COLS)", function (e) {
                        ...
                        i.key &&
                          ...
                          s.resize(),
                          layuiplay.event.call(this, N, "colToggled(" + c + ")", {
                            col: i,
                            config: u,
                          }));
                      });
                ...
                w.eventMoveElem &&
                  ...
                  a.cssRules(i, function (e) {
                    (l.width = parseFloat(e.style.width)),
                      layuiplay.event.call(t[0], N, "colResized(" + n + ")", {
                        col: l,
                        config: a.config,
                      });
                  }));
          ...
          a =
            ...
            s.elem.on(
              ...
              function (e) {
                ...
                if ((layuiplay.stope(e), t[0].disabled)) return !1;
          ...
          n = function (e, t) {
            ...
            (e = f(e)).data("off") ||
              ...
              (n = "function" == typeof n.edit ? n.edit(i) : n.edit) &&
                (((n = f(
                  "textarea" === n
                    ? '<textarea class="layuiplay-input ' +
                        W +
                        '" lay-unrow></textarea>'
                    : '<input class="layuiplay-input ' + W + '" lay-unrow>'
          ...
          i =
            (s.layBody
              .on("change", "." + W, function () {
                ...
                (e[i] = a),
                  l.update(e),
                  layuiplay.event.call(t[0], N, "edit(" + c + ")", l);
              })
              .on("blur", "." + W, function () {
                f(this).remove();
              }),
          ...
          t = function (e) {
            ...
            t.data("off") ||
              t.parent().hasClass(S) ||
              (e
                ? t.find(".layuiplay-table-grid-down").remove()
                : !(
                  ...
                  t.append(
                    '<div class="' +
                      i +
                      '"><i class="layuiplay-icon layuiplay-icon-down"></i></div>'
                  ));
          },
          l = function (e) {
            var t = f(this),
              ...
              a = a.children(y),
              o = "layuiplay-table-cell-c",
              d = f('<i class="layuiplay-icon layuiplay-icon-up ' + o + '">');
            "tips" === (l.expandedMode || u.cellExpandedMode)
              ? (s.tipsIndex = p.tips(
                  [
                    '<div class="layuiplay-table-tips-main" style="margin-top: -' +
                      (a.height() + 23) +
                      "px;" +
                      ("sm" === u.size
                    ...
                    a.html(),
                    "</div>",
                    '<i class="layuiplay-icon layuiplay-table-tips-c layuiplay-icon-close"></i>',
                  ].join(""),
                  a[0],
                  {
                    tips: [3, ""],
                    ...
                    isOutAnim: !1,
                    skin: "layuiplay-table-tips",
                    success: function (e, t) {
                      e.find(".layuiplay-table-tips-c").on("click", function () {
                        p.close(t);
                      });
                    },
                  }
        ...
        s.layBody
          .on("click", "*[lay-event]", function (e) {
            h.call(this), layuiplay.stope(e);
          })
          .on("dblclick", "*[lay-event]", function (e) {
            h.call(this, "toolDouble"), layuiplay.stope(e);
          }),
      ...
      d.on("resize", function () {
        layuiplay.each(w.that, function () {
          this.resize();
        });
      }),
      I.on("click", function () {
      ...
      function (a, i, e, l) {
        ...
        l.colGroup &&
          ...
          layuiplay.each(i[o], function (e, t) {
            t.parentKey
              ? t.parentKey === l.key &&
  ...
  (k.eachCols = function (e, a, i) {
    var e = w.config[e] || {},
      ...
      n =
        ...
        function (e) {
          layuiplay.each(e || l, function (e, t) {
    ...
    (k.checkStatus = function (e) {
      ...
      return (
        layuiplay.each(e, function (e, t) {
          "array" === layuiplay.type(t) || t[k.config.disabledName]
            ? i++
    ...
    (k.getData = function (e) {
      ...
      return (
        layuiplay.each(e, function (e, t) {
          "array" !== layuiplay.type(t) && a.push(k.clearCacheKey(t));
        }),
        a
      );
    }),
    ...
    (k.exportFile = function (e, t, a) {
      ...
      (u.href =
        ...
        encodeURIComponent(
          ...
          layuiplay.each(t, function (i, l) {
            ...
            "object" == typeof e
              ? (layuiplay.each(e, function (e, t) {
                ...
                layuiplay.each(
                  layuiplay.isArray(l) ? f.extend([], l) : k.clearCacheKey(l),
                  function (e, t) {
                    n.push('"' + (t || "") + '"');
                  }
                ))
          ...
          c &&
            layuiplay.each(c.dataTotal, function (e, t) {
    ...
    (k.hideCol = function (e, l) {
      ...
      n &&
        ("boolean" === layuiplay.type(l)
          ...
          : ((l = layuiplay.isArray(l) ? l : [l]),
            layuiplay.each(l, function (e, l) {
              n.eachCols(function (e, t) {
                var a, i;
                l.field === t.field &&
                  ((a = t.key),
    ...
    (k.reloadData = function () {
      ...
      return (
        layuiplay.each(a[1], function (e, t) {
...
layuiplay.define(["table"], function (e) {
  "use strict";
  var E = layuiplay.$,
    x = layuiplay.form,
    B = layuiplay.table,
    ...
    F = "layuiplay-hide",
    L = ".layuiplay-table-main",
    q = ".layuiplay-table-fixed-l",
    R = ".layuiplay-table-fixed-r",
    l = "layuiplay-table-checked",
    h = "layuiplay-table-tree",
    Y = "LAY_DATA_INDEX",
        ...
        ? (e && (!c || c.mod)) ||
          ((a.parseData = function () {
            var e = this,
              ...
              a = t[0],
              t =
                ("function" === layuiplay.type(c) && (a = c.apply(e, t) || t[0]),
                e.response.dataName);
            return (
              n.data.isSimpleData &&
                !n["async"].enable &&
  ...
  (t.prototype.init = function () {
    ...
    (t.prototype.config = {
      tree: {
        ...
        view: {
          indent: 14,
          flexIconClose: '<i class="layuiplay-icon layuiplay-icon-triangle-r"></i>',
          flexIconOpen: '<i class="layuiplay-icon layuiplay-icon-triangle-d"></i>',
          showIcon: !0,
          icon: "",
          iconClose: '<i class="layuiplay-icon layuiplay-icon-folder"></i>',
          iconOpen: '<i class="layuiplay-icon layuiplay-icon-folder-open"></i>',
          iconLeaf: '<i class="layuiplay-icon layuiplay-icon-leaf"></i>',
    ...
    (t.prototype.flatToTree = function (e) {
      ...
      return (
        ...
        (i = i || "children"),
        (r = {}),
        layuiplay.each(o, function (e, t) {
          (l = a + t[a]), (r[l] = E.extend({}, t)), (r[l][i] = []);
        }),
        layuiplay.each(r, function (e, t) {
  ...
  var r,
    V = function (e, t, a) {
      return r[e] || (r[e] = layuiplay.debounce(t, a)), r[e];
    },
    U = function (t, a, n, i, l) {
      var e = t.trElem,
        d = t.tableViewElem || e.closest(".layuiplay-table-view"),
        ...
        p = "boolean" !== layuiplay.type(a),
        x = p ? !y[H] : a,
        h = y[f] ? x : null;
      if (l && x != y[H] && (!y[X] || "local" === y[X])) {
        var m = u.callback.beforeExpand;
        if ("function" === layuiplay.type(m) && !1 === m(r, y, a)) return h;
      }
      var m = y[z],
        b = d.find('tr[lay-data-index="' + e + '"]'),
        g = b.find(".layuiplay-table-tree-flexIcon"),
        v =
          ...
          u.view.showIcon &&
            b
              .find(
                ".layuiplay-table-tree-nodeIcon:not(.layuiplay-table-tree-iconCustom,.layuiplay-table-tree-iconLeaf)"
              )
      ...
      if ((v !== undefined && (c.status.expand[v] = x), null !== h)) {
          ...
          if (m) {
            ...
            if (m.enable && y[f] && !y[X])
              return (
                (y[X] = "loading"),
                g.html(
                  '<i class="layuiplay-icon layuiplay-icon-loading layuiplay-anim layuiplay-anim-loop layuiplay-anim-rotate"></i>'
                ),
                (N = function (e) {
                  (y[X] = "success"),
                    (y[s.children] = e),
                ...
                (C = m.format),
                "function" === layuiplay.type(C)
                  ? C(y, o, N)
                  : ((I = E.extend({}, m.where || o.where)),
                    (C = m.autoParam),
                    layuiplay.each(C, function (e, t) {
                      t = t.split("=");
            ...
            (y[z] = !0),
              v.length &&
                (!o.initSort ||
                  (o.url && !o.autoSort) ||
                  ((m = o.initSort).type
                    ? layuiplay.sort(v, m.field, "desc" === m.type, !0)
                    : layuiplay.sort(v, B.config.indexName, null, !0)),
                c.initData(y[s.children], y[Y]),
        ...
        V(
          ...
          l &&
            "loading" !== y[X] &&
            ((C = u.callback.onExpand), "function" === layuiplay.type(C)) &&
            C(r, y, x);
      }
      return h;
    },
    g =
          ...
          if (e) {
            ...
            if (i["async"].enable) {
              ...
              if (
                ...
                return void layuiplay.each(j.getData(a), function (e, t) {
            ...
            if (
              ...
              t.updateStatus(null, function (e) {
                ...
                l.find(".layuiplay-table-tree-flexIcon").html(i.view.flexIconOpen),
                i.view.showIcon &&
                  l
                    .find(
                      ".layuiplay-table-tree-nodeIcon:not(.layuiplay-table-tree-iconCustom,.layuiplay-table-tree-iconLeaf)"
              ...
              layuiplay.each(e, function (e, t) {
                ...
                layuiplay.each(["main", "fixed-l", "fixed-r"], function (e, t) {
                  l.find(".layuiplay-table-" + t + " tbody").html(
            ...
            t.updateStatus(null, function (e) {
              ...
              l.find('.layuiplay-table-box tbody tr[data-level!="0"]').addClass(F),
              l.find(".layuiplay-table-tree-flexIcon").html(i.view.flexIconClose),
              i.view.showIcon &&
                l
                  .find(
                    ".layuiplay-table-tree-nodeIcon:not(.layuiplay-table-tree-iconCustom,.layuiplay-table-tree-iconLeaf)"
      ...
      (t.prototype.renderTreeTable = function (e, t, a) {
        var n = this,
          ...
          f =
            ((t = t || 0) ||
              (l
                .find(".layuiplay-table-body tr:not([data-level])")
                .attr("data-level", t),
              layuiplay.each(B.cache[d], function (e, t) {
                l
                  .find(
                    '.layuiplay-table-main tbody tr[data-level="0"]:eq(' + e + ")"
                  )
                  .attr("lay-data-index", t[Y]),
                  l
                    .find(
                      '.layuiplay-table-fixed-l tbody tr[data-level="0"]:eq(' +
                        e +
                        ")"
                    )
                    .attr("lay-data-index", t[Y]),
                  l
                    .find(
                      '.layuiplay-table-fixed-r tbody tr[data-level="0"]:eq(' +
                        e +
                        ")"
                    )
                    .attr("lay-data-index", t[Y]);
          ...
          p = o.indent || 14;
        if (
          (layuiplay.each(e.find('td[data-field="' + y + '"]'), function (e, t) {
            var a,
              n,
              i = (t = E(t)).closest("tr"),
              t = t.children(".layuiplay-table-cell");
            t.hasClass("layuiplay-table-tree-item") ||
              ((n = i.attr("lay-data-index")) &&
                ...
                (n = t.html()),
                (t = i.find(
                  'td[data-field="' + y + '"]>div.layuiplay-table-cell'
                )).addClass("layuiplay-table-tree-item"),
                t
                  .html(
                    [
                      '<div class="layuiplay-inline layuiplay-table-tree-flexIcon" ',
                      'style="',
                      ...
                      "</div>",
                      o.showIcon
                        ? '<div class="layuiplay-inline layuiplay-table-tree-nodeIcon' +
                          (a[c.icon] || o.icon
                            ? " layuiplay-table-tree-iconCustom"
                            : "") +
                          (a[u] ? "" : " layuiplay-table-tree-iconLeaf") +
                          '">' +
                          (a[c.icon] ||
                            o.icon ||
                            (a[u]
                  ...
                  .find(".layuiplay-table-tree-flexIcon")
                  .on("click", function (e) {
                    layuiplay.stope(e), U({ trElem: i }, null, null, null, !0);
                  })));
          }),
        ...
        !1 !== a && f
          ? layuiplay.each(f, function (e, t) {
              e = l.find('tr[lay-data-index="' + e + '"]');
              e.find(".layuiplay-table-tree-flexIcon").html(o.flexIconOpen),
                U({ trElem: e.first() }, !0);
            })
          : V(
              "renderTreeTable-" + d,
              function () {
                i.hasNumberCol && g(n),
                  x.render(E('.layuiplay-table-tree[lay-id="' + d + '"]'));
              },
              0
            )();
      }),
      function (a) {
        var e = a.getOptions(),
          t = e.elem.next(),
          n = 0,
          i = t.find(".layuiplay-table-main tbody tr"),
          l = t.find(".layuiplay-table-fixed-l tbody tr"),
          d = t.find(".layuiplay-table-fixed-r tbody tr");
        layuiplay.each(a.treeToFlat(B.cache[e.id]), function (e, t) {
          t.LAY_HIDE ||
    ...
    p =
      ...
      (t.prototype.reload = function (e, t, a) {
        ...
        (e = e || {}),
          delete n.haveInit,
          layuiplay.each(e, function (e, t) {
            "array" === layuiplay.type(t) && delete n.config[e];
          }),
      ...
      function (e, a, n, i) {
        ...
        return (
          layuiplay.each(e, function (e, t) {
            "function" === layuiplay.type(a) ? a(t) : E.extend(t, a),
              l.push(E.extend({}, t)),
          ...
          return (
            a in e[0] &&
              n.tr
                ...
                .children("div.layuiplay-table-cell")
                .removeClass("layuiplay-table-tree-item"),
    ...
    u =
      ((j.updateNode = function (e, a, t) {
        ...
        o &&
          ...
          layuiplay.each(["main", "fixed-l", "fixed-r"], function (e, t) {
            n.find(
              ".layuiplay-table-" + t + ' tbody tr[lay-data-index="' + a + '"]'
            ).replaceWith(
      ...
      (j.removeNode = function (e, t) {
        ...
        r &&
          ...
          layuiplay.each(l, function (e, t) {
            i.push('tr[lay-data-index="' + t[Y] + '"]');
          }),
          n.find(i.join(",")).remove(),
          (d = r.initData()),
          layuiplay.each(r.treeToFlat(d), function (e, t) {
            t[m] &&
              t[m] !== t[Y] &&
              n
          ...
          layuiplay.each(B.cache[e], function (e, t) {
      ...
      (j.addNodes = function (e, t) {
        ...
        if (a) {
          var n = a.getOptions(),
            ...
            c = t.data,
            t = t.focus,
            u = (r = "number" === layuiplay.type(r) ? r.toString() : r)
              ? a.getNodeDataByIndex(r)
              : null,
            o = "number" === layuiplay.type(o) ? o : -1,
            c = E.extend(!0, [], layuiplay.isArray(c) ? c : [c]);
          layuiplay.each(c, function (e, t) {
            d in t || (t[d] = u[d]);
          }),
            a.getTableData();
      ...
      (t.prototype.setRowCheckedClass = function (e, t) {
        ...
        e[t ? "addClass" : "removeClass"](l),
          e.each(function () {
            ...
            n.find('.layuiplay-table-fixed-r tbody tr[data-index="' + e + '"]')[
        ...
        return (
          ...
          ("all" !== (d = a.data.cascade) && "parent" !== d) ||
            ...
            ((d = c.updateParentCheckStatus(
              e,
              "boolean" === layuiplay.type(t) ? t : null
            )),
            layuiplay.each(d, function (e, t) {
              var a = i.find(
                  'tr[lay-data-index="' +
                    t[Y] +
      ...
      (t.prototype.updateParentCheckStatus = function (a, n) {
        ...
        return (
          !(a[b] = !1) === n
            ? a[t].length
              ? layuiplay.each(a[t], function (e, t) {
      ...
      function (e, t, a) {
        ...
        if (a) {
          ...
          i
            ? t && !o.prop("checked") && a()
            : ("boolean" === layuiplay.type(t) && o.prop("checked") === t) || a();
        } else {
          var c,
          ...
          if (!i)
            return (
              (t = "boolean" === layuiplay.type(t) ? t : !a[u]),
              (i = n.updateStatus(
                a ? [a] : B.cache[d],
                function (e) {
  ...
  j.on("checkbox", function (e) {
    ...
    (j.setRowChecked = function (a, e) {
      ...
      c &&
        ...
        (n = e.checked),
        (e = e.callbackFlag),
        (i = "string" === layuiplay.type(i) ? i : i[Y]),
        ...
        (d = t.find('tr[lay-data-index="' + i + '"]')).length ||
          ...
          (o = []),
          l(r),
          layuiplay.each(o.reverse(), function (e, t) {
    ...
    (j.getData = function (e, t) {
      ...
      if (n)
        return (
          (a = []),
          layuiplay.each(E.extend(!0, [], B.cache[e] || []), function (e, t) {
            a.push(t);
          }),
          t ? n.treeToFlat(a) : a
        );
...
layuiplay.define("form", function (e) {
  "use strict";
  var p = layuiplay.$,
    i = layuiplay.form,
    y = layuiplay.layer,
    ...
    t = {
      ...
      index: layuiplay[a] ? layuiplay[a].index + 1e4 : 0,
      set: function (e) {
        var i = this;
        return (i.config = p.extend({}, i.config, e)), i;
      },
      on: function (e, i) {
        return layuiplay.onevent.call(this, a, e, i);
      },
    },
    n = function () {
      var i = this,
    ...
    f = "layuiplay-hide",
    u = "layuiplay-disabled",
    m = "layuiplay-tree-set",
    k = "layuiplay-tree-iconClick",
    C = "layuiplay-icon-addition",
    v = "layuiplay-icon-subtraction",
    x = "layuiplay-tree-entry",
    b = "layuiplay-tree-main",
    g = "layuiplay-tree-txt",
    w = "layuiplay-tree-pack",
    N = "layuiplay-tree-spread",
    F = "layuiplay-tree-setLineShort",
    T = "layuiplay-tree-showLine",
    L = "layuiplay-tree-lineExtend",
    l = function (e) {
      var i = this;
      (i.index = ++t.index),
  ...
  (l.prototype.config = {
    ...
    (l.prototype.reload = function (e) {
      var a = this;
      layuiplay.each(e, function (e, i) {
        "array" === layuiplay.type(i) && delete a.config[e];
      }),
    ...
    (l.prototype.render = function () {
      var e = this,
        ...
        a =
          ...
          (e.checkids = []),
          p(
            '<div class="layuiplay-tree layuiplay-border-box' +
              (i.showCheckbox ? " layuiplay-form" : "") +
              (i.showLine ? " layuiplay-tree-line" : "") +
              '" lay-filter="LAY-tree-' +
              e.index +
              '"></div>'
          )),
      ...
      if (n[0]) {
        if (
          ...
          (e.elem = a),
          (e.elemNone = p(
            '<div class="layuiplay-tree-emptyText">' + i.text.none + "</div>"
          )),
          n.html(e.elem),
          0 == e.elem.find(".layuiplay-tree-set").length)
        )
          return e.elem.append(e.elemNone);
        i.showCheckbox && e.renderForm("checkbox"),
          e.elem.find(".layuiplay-tree-set").each(function () {
            var e = p(this);
            e.parent(".layuiplay-tree-pack")[0] || e.addClass("layuiplay-tree-setHide"),
              !e.next()[0] &&
                e
                  .parents(".layuiplay-tree-pack")
                  .eq(1)
                  .hasClass("layuiplay-tree-lineExtend") &&
                e.addClass(F),
              e.next()[0] ||
                e.parents(".layuiplay-tree-set").eq(0).next()[0] ||
                e.addClass(F);
          }),
          e.events();
      }
      ...
      layuiplay.each(e, function (e, i) {
        var a,
          ...
          c = p(
            [
              '<div data-id="' +
                i[o.id] +
                '" class="layuiplay-tree-set' +
                (i.spread ? " layuiplay-tree-spread" : "") +
                (i.checked ? " layuiplay-tree-checkedFirst" : "") +
                '">',
              '<div class="layuiplay-tree-entry">',
              '<div class="layuiplay-tree-main">',
              s.showLine
                ? t
                  ? '<span class="layuiplay-tree-iconClick layuiplay-tree-icon"><i class="layuiplay-icon ' +
                    (i.spread
                      ? "layuiplay-icon-subtraction"
                      : "layuiplay-icon-addition") +
                    '"></i></span>'
                  : '<span class="layuiplay-tree-iconClick"><i class="layuiplay-icon layuiplay-icon-file"></i></span>'
                : '<span class="layuiplay-tree-iconClick"><i class="layuiplay-tree-iconArrow ' +
                  (t ? "" : f) +
                  '"></i></span>',
              s.showCheckbox
                ? '<input type="checkbox" name="' +
                  (i.field || "layuiplayTreeCheck_" + i[o.id]) +
                  '" same="layuiplayTreeCheck" lay-skin="primary" ' +
                  (i.disabled ? "disabled" : "") +
                  ' value="' +
                  i[o.id] +
                  '">'
              ...
              s.edit
                ? ((a = {
                    add: '<i class="layuiplay-icon layuiplay-icon-add-1"  data-type="add"></i>',
                    update:
                      '<i class="layuiplay-icon layuiplay-icon-edit" data-type="update"></i>',
                    del: '<i class="layuiplay-icon layuiplay-icon-delete" data-type="del"></i>',
                  }),
                  (n = ['<div class="layuiplay-btn-group layuiplay-tree-btnGroup">']),
                  !0 === s.edit && (s.edit = ["update", "del"]),
                  "object" == typeof s.edit
                    ? (layuiplay.each(s.edit, function (e, i) {
                        n.push(a[i] || "");
                      }),
                      n.join("") + "</div>")
                    : void 0)
        ...
        t && (c.append(l), d.tree(l, i[o.children])),
          ...
          c.prev("." + m)[0] &&
            c
              .prev()
              .children(".layuiplay-tree-pack")
              .addClass("layuiplay-tree-showLine"),
          t || c.parent(".layuiplay-tree-pack").addClass("layuiplay-tree-lineExtend"),
          d.spread(c, i),
          s.showCheckbox &&
    ...
    (l.prototype.spread = function (n, t) {
      var l = this,
        ...
        e = n.children("." + x),
        i = e.children("." + b),
        a = i.find('input[same="layuiplayTreeCheck"]'),
        r = e.find("." + k),
        e = e.find("." + g),
      ...
      d.on("click", function (e) {
        var i = n.children("." + w),
          a = (
            d.children(".layuiplay-icon")[0] ? d : d.find(".layuiplay-tree-icon")
          ).children(".layuiplay-icon");
        i[0]
          ? n.hasClass(N)
            ? (n.removeClass(N),
    ...
    (l.prototype.setCheckbox = function (e, i, a) {
      ...
      a.prop("disabled") ||
        (("object" != typeof i[l.children] && !e.find("." + w)[0]) ||
          e
            .find("." + w)
            .find('input[same="layuiplayTreeCheck"]')
            .each(function (e) {
              this.disabled ||
        ...
        (t = function (e) {
          ...
          e.parents("." + m)[0] &&
            ...
            (n = e.prev().find('input[same="layuiplayTreeCheck"]')),
            c
              ? n.prop("checked", c)
              : (e.find('input[same="layuiplayTreeCheck"]').each(function () {
                  this.checked && (i = !0);
                }),
                i || n.prop("checked", !1)),
            t(a));
    ...
    (l.prototype.checkClick = function (a, n) {
      ...
      a.children("." + x)
        .children("." + b)
        .on("click", 'input[same="layuiplayTreeCheck"]+', function (e) {
          layuiplay.stope(e);
          var e = p(this).prev(),
            i = e.prop("checked");
          e.prop("disabled") ||
    ...
    (l.prototype.operate = function (r, d) {
      var s = this,
        ...
        e = r.children("." + x),
        h = e.children("." + b);
      e.children(".layuiplay-tree-btnGroup").on(
        "click",
        ".layuiplay-icon",
        function (e) {
          layuiplay.stope(e);
          ...
          if ("add" == e) {
            n[0] ||
              (o.showLine
                ? (h.find("." + k).addClass("layuiplay-tree-icon"),
                  h
                    .find("." + k)
                    .children(".layuiplay-icon")
                    .addClass(C)
                    .removeClass("layuiplay-icon-file"))
                : h.find(".layuiplay-tree-iconArrow").removeClass(f),
              r.append('<div class="layuiplay-tree-pack"></div>'));
            var a,
            ...
            if (
              ...
              return;
            h.find('input[same="layuiplayTreeCheck"]')[0].checked &&
              (r
                .children("." + w)
                .children("." + m)
                .last()
                .find('input[same="layuiplayTreeCheck"]')[0].checked = !0),
              s.renderForm("checkbox");
          } else
            "update" == e
              ? ((l = h.children("." + g).html()),
                h.children("." + g).html(""),
                h.append('<input type="text" class="layuiplay-tree-editInput">'),
                h.children(".layuiplay-tree-editInput").val(l).focus(),
                (i = function (e) {
                ...
                h.children(".layuiplay-tree-editInput").blur(function () {
                  i(p(this));
                }),
                h.children(".layuiplay-tree-editInput").on("keydown", function (e) {
                        ...
                        ? (r.siblings("." + m).children("." + x)[0]
                            ...
                            : ((e = r.parent("." + w).prev()),
                              o.showLine
                                ? (e
                                    .find("." + k)
                                    .removeClass("layuiplay-tree-icon"),
                                  e
                                    .find("." + k)
                                    .children(".layuiplay-icon")
                                    .removeClass(v)
                                    .addClass("layuiplay-icon-file"),
                                ...
                                : e.find(".layuiplay-tree-iconArrow").addClass(f),
                              r
                                .parents("." + m)
                                .eq(0)
                                .removeClass(N),
    ...
    (l.prototype.events = function () {
      var i = this,
        t = i.config;
      i.elem.find(".layuiplay-tree-checkedFirst");
      i.setChecked(i.checkids),
        i.elem.find(".layuiplay-tree-search").on("keyup", function () {
          var e = p(this),
            a = e.val(),
            e = e.nextAll(),
            n = [];
          e.find("." + g).each(function () {
            ...
            -1 != p(this).html().indexOf(a) &&
              ...
              (i = function (e) {
                e.addClass("layuiplay-tree-searchShow"),
                  e.parent("." + w)[0] && i(e.parent("." + w).parent("." + m));
              })(e.parent("." + m)));
          }),
            e.find("." + x).each(function () {
              var e = p(this).parent("." + m);
              e.hasClass("layuiplay-tree-searchShow") || e.addClass(f);
            }),
            0 == e.find(".layuiplay-tree-searchShow").length &&
              i.elem.append(i.elemNone),
            t.onsearch && t.onsearch({ elem: n });
        }),
        i.elem.find(".layuiplay-tree-search").on("keydown", function () {
          p(this)
            .nextAll()
            .find("." + x)
            .each(function () {
              p(this)
                .parent("." + m)
                .removeClass("layuiplay-tree-searchShow " + f);
            }),
            p(".layuiplay-tree-emptyText")[0] &&
              p(".layuiplay-tree-emptyText").remove();
        });
    }),
    (l.prototype.getChecked = function () {
      var t = this,
        ...
        a = [],
        c =
          (t.elem.find(".layuiplay-form-checked").each(function () {
            i.push(p(this).prev()[0].value);
          }),
          function (e, n) {
            layuiplay.each(e, function (e, a) {
              layuiplay.each(i, function (e, i) {
                if (a[l.id] == i)
                  return (
...
layuiplay.define(["laytpl", "form"], function (e) {
  "use strict";
  var s = layuiplay.$,
    n = layuiplay.laytpl,
    t = layuiplay.form,
    ...
    i = {
      ...
      on: function (e, t) {
        return layuiplay.onevent.call(this, a, e, t);
      },
    },
    l = function () {
      var t = this,
    ...
    d = "layuiplay-hide",
    h = "layuiplay-btn-disabled",
    r = "layuiplay-none",
    c = "layuiplay-transfer-box",
    u = "layuiplay-transfer-header",
    o = "layuiplay-transfer-search",
    f = "layuiplay-transfer-data",
    y = function (e) {
      return [
        '<div class="layuiplay-transfer-box" data-index="' +
          (e = e || {}).index +
          '">',
        '<div class="layuiplay-transfer-header">',
        '<input type="checkbox" name="' +
          e.checkAllName +
        ...
        '<div class="layuiplay-transfer-search">',
        '<i class="layuiplay-icon layuiplay-icon-search"></i>',
        '<input type="text" class="layuiplay-input" placeholder="\u5173\u952e\u8bcd\u641c\u7d22">',
        "</div>",
        "{{# } }}",
        '<ul class="layuiplay-transfer-data"></ul>',
        "</div>",
      ].join("");
    },
    p = [
      '<div class="layuiplay-transfer layuiplay-form layuiplay-border-box" lay-filter="LAY-transfer-{{= d.index }}">',
      y({ index: 0, checkAllName: "layTransferLeftCheckAll" }),
      '<div class="layuiplay-transfer-active">',
      '<button type="button" class="layuiplay-btn layuiplay-btn-sm layuiplay-btn-primary layuiplay-btn-disabled" data-index="0">',
      '<i class="layuiplay-icon layuiplay-icon-next"></i>',
      "</button>",
      '<button type="button" class="layuiplay-btn layuiplay-btn-sm layuiplay-btn-primary layuiplay-btn-disabled" data-index="1">',
      '<i class="layuiplay-icon layuiplay-icon-prev"></i>',
      "</button>",
      "</div>",
  ...
  (v.prototype.config = {
    ...
    (v.prototype.render = function () {
      ...
      i[0] &&
        ...
        (e.layData = a.find("." + f)),
        (e.layBtn = a.find(".layuiplay-transfer-active .layuiplay-btn")),
    ...
    (v.prototype.renderData = function () {
      ...
      e.parseData(function (a) {
        ...
        i
          ? layuiplay.each(t.value, function (e, t) {
    ...
    (v.prototype.noneView = function (e, t) {
      var a = s('<p class="layuiplay-none">' + (t || "") + "</p>");
    ...
    (v.prototype.parseData = function (t) {
      var i = this.config,
        n = [];
      return (
        layuiplay.each(i.data, function (e, a) {
          (a = ("function" == typeof i.parseData ? i.parseData(a) : a) || a),
            n.push((a = s.extend({}, a))),
            layuiplay.each(i.value, function (e, t) {
    ...
    (v.prototype.getData = function (e) {
      ...
      return (
        this.setValue(),
        layuiplay.each(e || t.value, function (e, a) {
          layuiplay.each(t.data, function (e, t) {
...
layuiplay.define(["jquery", "lay"], function (e) {
  ...
  var a = layuiplay.$,
    ...
    r = "carousel",
    d = "layuiplay-this",
    s = "layuiplay-carousel-left",
    u = "layuiplay-carousel-right",
    c = "layuiplay-carousel-prev",
    m = "layuiplay-carousel-next",
    l = "layuiplay-carousel-arrow",
    f = "layuiplay-carousel-ind",
    i = function (e) {
      var i = this;
  ...
  (i.prototype.config = {
      ...
      var i,
        ...
        t = (e.elemInd = a(
          [
            '<div class="' + f + '"><ul>',
            ((i = []),
            layuiplay.each(e.elemItem, function (e) {
              i.push(
                "<li" + (n.index === e ? ' class="layuiplay-this"' : "") + "></li>"
              );
            }),
            i.join("")),
            "</ul></div>",
    ...
    (i.prototype.slide = function (e, i) {
      ...
      n.haveSlide ||
        ...
        layuiplay.event.call(this, r, "change(" + l + ")", e));
    }),
    (i.prototype.events = function () {
      var e = this,
        i = e.config;
...
layuiplay.define(["jquery", "lay"], function (e) {
  "use strict";
  var s = layuiplay.jquery,
    r = layuiplay.lay,
    c = {
      config: {},
      index: layuiplay.rate ? layuiplay.rate.index + 1e4 : 0,
      set: function (e) {
        var a = this;
        return (a.config = s.extend({}, a.config, e)), a;
      },
      on: function (e, a) {
        return layuiplay.onevent.call(this, l, e, a);
      },
    },
    l = "rate",
    f = "layuiplay-icon-rate",
    h = "layuiplay-icon-rate-solid",
    o = "layuiplay-icon-rate-half",
    u = "layuiplay-icon-rate-solid layuiplay-icon-rate-half",
    v = "layuiplay-icon-rate layuiplay-icon-rate-half",
    a = function (e) {
      var a = this;
      (a.index = ++c.index),
    ...
    (a.prototype.render = function () {
      ...
      for (
            ...
            parseInt(a.value) === a.value ||
              ...
              (a.value =
                Math.ceil(a.value) - a.value < 0.5
                  ? Math.ceil(a.value)
                  : Math.floor(a.value)),
            '<ul class="layuiplay-rate" ' + (a.readonly ? "readonly" : "") + ">"),
          t = 1;
        t <= a.length;
        t++
      ) {
        var o =
          '<li class="layuiplay-inline"><i class="layuiplay-icon ' +
        ...
        a.half && parseInt(a.value) !== a.value && t == Math.ceil(a.value)
          ? (n =
              n +
              '<li><i class="layuiplay-icon layuiplay-icon-rate-half" ' +
              i +
              "></i></li>")
          : (n += o);
      }
      n +=
        "</ul>" +
        (a.text ? '<span class="layuiplay-inline">' + a.value + "\u661f" : "") +
        "</span>";
      var l = a.elem,
        u = l.next(".layuiplay-rate");
      u[0] && u.remove(),
        (e.elemTemp = s(n)),
        (a.span = e.elemTemp.next("span")),
        a.setText && a.setText(a.value),
        l.html(e.elemTemp),
        l.addClass("layuiplay-inline"),
        a.readonly || e.action();
    }),
            ...
            n.find("i").each(function () {
              ...
              i.half &&
                ...
                n
                  ...
                  .children("i")
                  .addClass(o)
                  .removeClass("layuiplay-icon-rate-solid layuiplay-icon-rate");
          });
      });
    }),
...
layuiplay.define("jquery", function (l) {
  "use strict";
  var g = layuiplay.$,
    e = function (l) {};
  (e.prototype.load = function (l) {
    ...
    if (h[0])
      return (
        ...
        (u = g(
          '<div class="layuiplay-flow-more"><a href="javascript:;">' +
            (s = "<cite>\u52a0\u8f7d\u66f4\u591a</cite>") +
            "</a></div>"
        )),
        h.find(".layuiplay-flow-more")[0] || h.append(u),
        (f = function (l, e) {
          (l = g(l)),
            u.before(l),
        ...
        (y = function () {
          (t = !0),
            u
              .find("a")
              .html(
                '<i class="layuiplay-anim layuiplay-anim-rotate layuiplay-anim-loop layuiplay-icon ">&#xe63e;</i>'
              ),
...
layuiplay.define(["lay", "util", "element", "form"], function (e) {
  "use strict";
  var x = layuiplay.$,
    D = layuiplay.util,
    S = layuiplay.element,
    ...
    A =
      (layuiplay.hint(),
      {
        ELEM_VIEW: "layuiplay-code-view",
        ELEM_TAB: "layuiplay-tab",
        ELEM_HEADER: "layuiplay-code-header",
        ELEM_FULL: "layuiplay-code-full",
        ELEM_PREVIEW: "layuiplay-code-preview",
        ELEM_ITEM: "layuiplay-code-item",
        ELEM_SHOW: "layuiplay-show",
        ELEM_LINE: "layuiplay-code-line",
        ELEM_LINE_NUM: "layuiplay-code-line-number",
        ELEM_LN_MODE: "layuiplay-code-ln-mode",
        CDDE_DATA_CLASS: "layuiplayCodeDataClass",
        LINE_RAW_WIDTH: 45,
      }),
    T = {
      elem: "",
    ...
    W = layuiplay.code ? layuiplay.code.index + 1e4 : 0,
    R = function (e) {
      return String(e)
        .replace(/\s+$/, "")
        .replace(/^\n|\n$/, "");
  ...
  e("code", function (l, e) {
    var o,
      ...
      g = {
        ...
        reload: function (e) {
          layuiplay.code(this.updateOptions(e));
        },
        updateOptions: function (e) {
          return delete (e = e || {}).elem, x.extend(!0, l, e);
        },
        reloadCode: function (e) {
          layuiplay.code(this.updateOptions(e), "reloadCode");
        },
      },
      w = x(l.elem);
    return (
      1 < w.length
        ? layuiplay.each(l.obverse ? w : w.get().reverse(), function () {
            layuiplay.code(x.extend({}, l, { elem: this }), e);
          })
        : (o = l.elem = x(l.elem))[0] &&
          (x.extend(
            !0,
              ...
              html: (e = x.map(t, function (e, t) {
                return [
                  ...
                  l.ln
                    ...
                    : "",
                  '<div class="layuiplay-code-line-content">',
                  e || " ",
                  "</div>",
                  "</div>",
                ].join("");
          ...
          "reloadCode" === e
            ? o.children(".layuiplay-code-wrap").html(w(n(a)).html)
            : ((d = layuiplay.code.index = ++W),
              ...
              l.preview &&
                ...
                (C = x('<div class="layuiplay-tab layuiplay-tab-brief">')),
                (r = x('<div class="layuiplay-tab-title">')),
                (_ = x(
                  '<div class="' +
                    [
                      A.ELEM_ITEM,
                ...
                (u = x('<div class="layuiplay-code-tools"></div>')),
                l.id && E.attr("id", l.id),
                E.addClass(l.className),
                C.attr("lay-filter", M),
                layuiplay.each(f, function (e, t) {
                  var a = x('<li lay-id="' + t + '">');
                  0 === e && a.addClass("layuiplay-this"),
                    a.html(l.text[t]),
                    r.append(a);
                }),
                x.extend(c, {
                  full: {
                    ...
                    event: function (e) {
                      var e = e.elem,
                        ...
                        a = "layuiplay-icon-" + this.className,
                        i = "layuiplay-icon-screen-restore",
                        l = this.title,
                        o = x("html,body"),
                        n = "layuiplay-scrollbar-hide";
                      e.hasClass(a)
                ...
                layuiplay.each(l.tools, function (e, t) {
                    ...
                    setTimeout(function () {
                      "function" == typeof l.done &&
                        l.done({
                          ...
                          options: l,
                          render: function () {
                            I.render(e.find(".layuiplay-form")), S.render();
                          },
                        });
                    }, 3);
                }),
              ...
              (p = x('<code class="layuiplay-code-wrap"></code>')),
              o.addClass(
                ((E = ["layuiplay-code-view layuiplay-border-box"]),
                l.wordWrap || E.push("layuiplay-code-nowrap"),
                E.join(" "))
              ),
              (C = l.theme || l.skin) &&
                (o.removeClass("layuiplay-code-theme-dark layuiplay-code-theme-light"),
                o.addClass("layuiplay-code-theme-" + C)),
              l.highlighter &&
                o.addClass(
                  [l.highlighter, "language-" + l.lang, "layuiplay-code-hl"].join(
                    " "
                  )
                ),
              ...
              l.ln && o.append('<div class="layuiplay-code-ln-side"></div>'),
              ...
              (v = [
                {
                  selector: ">.layuiplay-code-wrap>.layuiplay-code-line{}",
                ...
                {
                  selector:
                    ">.layuiplay-code-wrap>.layuiplay-code-line>.layuiplay-code-line-number{}",
                  setValue: function (e, t) {
                    e.style.width = t + "px";
                  },
                },
                {
                  selector: ">.layuiplay-code-ln-side{}",
                  setValue: function (e, t) {
                    e.style.width = t + "px";
                  },
                },
              ...
              (m = lay.style({
                ...
                text: x
                  .map(
                    ...
                    function (e, t) {
                      return [
                        '.layuiplay-code-view[lay-code-index="' + d + '"]',
                        e,
                      ].join(" ");
                    }
                  )
              ...
              l.header &&
                ...
                o.prepend(_)),
              (M = x('<div class="layuiplay-code-fixbar"></div>')),
              l.copy &&
                !l.preview &&
                ((C = x(
                  [
                    '<span class="layuiplay-code-copy">',
                    '<i class="layuiplay-icon layuiplay-icon-file-b" title="\u590d\u5236"></i>',
                    "</span>",
                  ].join("")
                )).on("click", function () {
                  c.copy.event();
              ...
              l.langMarker &&
                M.append(
                  '<span class="layuiplay-code-lang-marker">' + l.lang + "</span>"
                ),
  ...
  layuiplay["layuiplay.all"] || layuiplay.addcss("modules/code.css?v=6", "skincodecss");
//# sourceMappingURL=layuiplay.js.map
